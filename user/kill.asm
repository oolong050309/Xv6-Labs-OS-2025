...
main(int argc, char **argv)
{
  ...
  50:	83458593          	addi	a1,a1,-1996 # 880 <statistics+0x8c>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b8:	56c50513          	addi	a0,a0,1388 # 920 <digits>
 3bc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4be:	40e70713          	addi	a4,a4,1038 # 8c8 <statistics+0xd4>
 ...
 5a0:	2fc90913          	addi	s2,s2,764 # 898 <statistics+0xa4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 680:	2bc7b783          	ld	a5,700(a5) # 938 <freep>
 ...
 6a8:	00e6ea63          	bltu	a3,a4,6bc <free+0x4a>
{
 ...
 6ea:	24f73923          	sd	a5,594(a4) # 938 <freep>
}
 6ee:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 714:	22853503          	ld	a0,552(a0) # 938 <freep>
 ...
 744:	1f890913          	addi	s2,s2,504 # 938 <freep>
  if(p == (char*)-1)
 748:	5afd                	li	s5,-1
 ...
 758:	1ec78793          	addi	a5,a5,492 # 940 <base>
 75c:	00000717          	auipc	a4,0x0
 760:	1cf73e23          	sd	a5,476(a4) # 938 <freep>
 764:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d6:	16a73323          	sd	a0,358(a4) # 938 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 80e:	09650513          	addi	a0,a0,150 # 8a0 <statistics+0xac>
 812:	00000097          	auipc	ra,0x0
 816:	b02080e7          	jalr	-1278(ra) # 314 <open>
  if(fd < 0) {
 81a:	04054263          	bltz	a0,85e <statistics+0x6a>
 81e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 820:	4481                	li	s1,0
 822:	03205063          	blez	s2,842 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 826:	4099063b          	subw	a2,s2,s1
 82a:	009a05b3          	add	a1,s4,s1
 82e:	854e                	mv	a0,s3
 830:	00000097          	auipc	ra,0x0
 834:	abc080e7          	jalr	-1348(ra) # 2ec <read>
 838:	00054563          	bltz	a0,842 <statistics+0x4e>
      break;
    }
    i += n;
 83c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 83e:	ff24c4e3          	blt	s1,s2,826 <statistics+0x32>
  }
  close(fd);
 842:	854e                	mv	a0,s3
 844:	00000097          	auipc	ra,0x0
 848:	ab8080e7          	jalr	-1352(ra) # 2fc <close>
  return i;
}
 84c:	8526                	mv	a0,s1
 ...
 85c:	8082                	ret
      fprintf(2, "stats: open failed\n");
 85e:	00000597          	auipc	a1,0x0
 862:	05258593          	addi	a1,a1,82 # 8b0 <statistics+0xbc>
 866:	4509                	li	a0,2
 868:	00000097          	auipc	ra,0x0
 86c:	da6080e7          	jalr	-602(ra) # 60e <fprintf>
      exit(1);
 870:	4505                	li	a0,1
 872:	00000097          	auipc	ra,0x0
 876:	a62080e7          	jalr	-1438(ra) # 2d4 <exit>
