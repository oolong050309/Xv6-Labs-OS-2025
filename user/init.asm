...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45c:	5c850513          	addi	a0,a0,1480 # a20 <digits>
 460:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 562:	46a70713          	addi	a4,a4,1130 # 9c8 <statistics+0x130>
 ...
 5ee:	436b8b93          	addi	s7,s7,1078 # a20 <digits>
 ...
 644:	36890913          	addi	s2,s2,872 # 9a8 <statistics+0x110>
        while(*s != 0){
...
free(void *ap)
{
 ...
 724:	3287b783          	ld	a5,808(a5) # a48 <freep>
 ...
 74c:	00e6ea63          	bltu	a3,a4,760 <free+0x4a>
{
 ...
 78e:	2af73f23          	sd	a5,702(a4) # a48 <freep>
}
 792:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7b8:	29453503          	ld	a0,660(a0) # a48 <freep>
 ...
 7e8:	26490913          	addi	s2,s2,612 # a48 <freep>
  if(p == (char*)-1)
 7ec:	5afd                	li	s5,-1
 ...
 7fc:	25878793          	addi	a5,a5,600 # a50 <base>
 800:	00000717          	auipc	a4,0x0
 804:	24f73423          	sd	a5,584(a4) # a48 <freep>
 808:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 87a:	1ca73923          	sd	a0,466(a4) # a48 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 906:	0ae58593          	addi	a1,a1,174 # 9b0 <statistics+0x118>
 90a:	4509                	li	a0,2
