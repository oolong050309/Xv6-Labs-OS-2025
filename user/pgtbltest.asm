...
err(char *why)
{
  ...
  28:	99450513          	addi	a0,a0,-1644 # 9b8 <malloc+0x102>
...
ugetpid_test()
{
  ...
  4c:	99850513          	addi	a0,a0,-1640 # 9e0 <malloc+0x12a>
  50:	00000097          	auipc	ra,0x0
  54:	7ae080e7          	jalr	1966(ra) # 7fe <printf>
  testname = "ugetpid_test";
  58:	00001797          	auipc	a5,0x1
  5c:	9a078793          	addi	a5,a5,-1632 # 9f8 <malloc+0x142>
  ...
  94:	98850513          	addi	a0,a0,-1656 # a18 <malloc+0x162>
  ...
  ce:	93e50513          	addi	a0,a0,-1730 # a08 <malloc+0x152>
...
pgaccess_test()
{
  ...
  f2:	94250513          	addi	a0,a0,-1726 # a30 <malloc+0x17a>
  f6:	00000097          	auipc	ra,0x0
  fa:	708080e7          	jalr	1800(ra) # 7fe <printf>
  testname = "pgaccess_test";
  fe:	00001797          	auipc	a5,0x1
 102:	94a78793          	addi	a5,a5,-1718 # a48 <malloc+0x192>
 ...
 178:	0799                	addi	a5,a5,6 # 40000006 <__global_pointer$+0x3fffeccd>
 ...
 18c:	90050513          	addi	a0,a0,-1792 # a88 <malloc+0x1d2>
 ...
 1a6:	8b650513          	addi	a0,a0,-1866 # a58 <malloc+0x1a2>
 1aa:	00000097          	auipc	ra,0x0
 1ae:	e56080e7          	jalr	-426(ra) # 0 <err>
    err("pgaccess failed");
 1b2:	00001517          	auipc	a0,0x1
 1b6:	8a650513          	addi	a0,a0,-1882 # a58 <malloc+0x1a2>
 1ba:	00000097          	auipc	ra,0x0
 1be:	e46080e7          	jalr	-442(ra) # 0 <err>
    err("incorrect access bits set");
 1c2:	00001517          	auipc	a0,0x1
 1c6:	8a650513          	addi	a0,a0,-1882 # a68 <malloc+0x1b2>
...
00000000000001d2 <main>:
{
 ...
 1ee:	8b650513          	addi	a0,a0,-1866 # aa0 <malloc+0x1ea>
...
ugetpid(void)
{
 ...
 472:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffecc4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 57a:	5b250513          	addi	a0,a0,1458 # b28 <digits>
 57e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 680:	45470713          	addi	a4,a4,1108 # ad0 <malloc+0x21a>
 ...
 70c:	420b8b93          	addi	s7,s7,1056 # b28 <digits>
 ...
 762:	36a90913          	addi	s2,s2,874 # ac8 <malloc+0x212>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 906:	24690913          	addi	s2,s2,582 # b48 <freep>
  if(p == (char*)-1)
 90a:	5afd                	li	s5,-1
 ...
 91a:	23a78793          	addi	a5,a5,570 # b50 <base>
