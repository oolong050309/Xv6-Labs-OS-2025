...
void main(void) {
  ...
  28:	c7278793          	addi	a5,a5,-910 # 646c72 <__global_pointer$+0x645bb9>
  ...
  printf("%c%c%c\n",c1,c2,c3);
  30:	07200693          	li	a3,114
  34:	06c00613          	li	a2,108
  38:	06400593          	li	a1,100
  3c:	00000517          	auipc	a0,0x0
  40:	7e450513          	addi	a0,a0,2020 # 820 <malloc+0x102>
  44:	00000097          	auipc	ra,0x0
  48:	622080e7          	jalr	1570(ra) # 666 <printf>
  
  printf("H%x Wo%s\n", 57616, &i);
  4c:	fec40613          	addi	a2,s0,-20
  50:	65b9                	lui	a1,0xe
  52:	11058593          	addi	a1,a1,272 # e110 <__global_pointer$+0xd057>
  56:	00000517          	auipc	a0,0x0
  5a:	7d250513          	addi	a0,a0,2002 # 828 <malloc+0x10a>
  5e:	00000097          	auipc	ra,0x0
  62:	608080e7          	jalr	1544(ra) # 666 <printf>
  
  printf("x=%d y=%d\n", 3);
  66:	458d                	li	a1,3
  68:	00000517          	auipc	a0,0x0
  6c:	7d050513          	addi	a0,a0,2000 # 838 <malloc+0x11a>
  70:	00000097          	auipc	ra,0x0
  74:	5f6080e7          	jalr	1526(ra) # 666 <printf>
  exit(0);
  78:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e8:	36c70713          	addi	a4,a4,876 # 850 <malloc+0x132>
 ...
 574:	338b8b93          	addi	s7,s7,824 # 8a8 <digits>
 ...
 5ca:	28290913          	addi	s2,s2,642 # 848 <malloc+0x12a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6aa:	21a7b783          	ld	a5,538(a5) # 8c0 <freep>
 ...
 6d2:	00e6ea63          	bltu	a3,a4,6e6 <free+0x4a>
{
 ...
 714:	1af73823          	sd	a5,432(a4) # 8c0 <freep>
}
 718:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 73e:	18653503          	ld	a0,390(a0) # 8c0 <freep>
 ...
 76e:	15690913          	addi	s2,s2,342 # 8c0 <freep>
  if(p == (char*)-1)
 772:	5afd                	li	s5,-1
