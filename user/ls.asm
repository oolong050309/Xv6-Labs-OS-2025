...
fmtname(char *path)
{
  ...
  66:	ba698993          	addi	s3,s3,-1114 # c08 <buf.0>
...
ls(char *path)
{
 ...
 118:	a0c50513          	addi	a0,a0,-1524 # b20 <statistics+0xbc>
 ...
 14a:	9aa58593          	addi	a1,a1,-1622 # af0 <statistics+0x8c>
 14e:	4509                	li	a0,2
 ...
 160:	9ac58593          	addi	a1,a1,-1620 # b08 <statistics+0xa4>
 164:	4509                	li	a0,2
 ...
 196:	99e50513          	addi	a0,a0,-1634 # b30 <statistics+0xcc>
 ...
 1e6:	966a0a13          	addi	s4,s4,-1690 # b48 <statistics+0xe4>
        printf("ls: cannot stat %s\n", buf);
 1ea:	00001a97          	auipc	s5,0x1
 1ee:	91ea8a93          	addi	s5,s5,-1762 # b08 <statistics+0xa4>
...
main(int argc, char *argv[])
{
 ...
 2c2:	89a50513          	addi	a0,a0,-1894 # b58 <statistics+0xf4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 628:	5c450513          	addi	a0,a0,1476 # be8 <digits>
 62c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72e:	46670713          	addi	a4,a4,1126 # b90 <statistics+0x12c>
 ...
 7ba:	432b8b93          	addi	s7,s7,1074 # be8 <digits>
 ...
 810:	35490913          	addi	s2,s2,852 # b60 <statistics+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8f0:	3147b783          	ld	a5,788(a5) # c00 <freep>
 ...
 918:	00e6ea63          	bltu	a3,a4,92c <free+0x4a>
{
 ...
 95a:	2af73523          	sd	a5,682(a4) # c00 <freep>
}
 95e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 984:	28053503          	ld	a0,640(a0) # c00 <freep>
 ...
 9b4:	25090913          	addi	s2,s2,592 # c00 <freep>
  if(p == (char*)-1)
 9b8:	5afd                	li	s5,-1
 ...
 9c8:	25478793          	addi	a5,a5,596 # c18 <base>
 9cc:	00000717          	auipc	a4,0x0
 9d0:	22f73a23          	sd	a5,564(a4) # c00 <freep>
 9d4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a46:	1aa73f23          	sd	a0,446(a4) # c00 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a7e:	0ee50513          	addi	a0,a0,238 # b68 <statistics+0x104>
 a82:	00000097          	auipc	ra,0x0
 a86:	b02080e7          	jalr	-1278(ra) # 584 <open>
  if(fd < 0) {
 a8a:	04054263          	bltz	a0,ace <statistics+0x6a>
 a8e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a90:	4481                	li	s1,0
 a92:	03205063          	blez	s2,ab2 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a96:	4099063b          	subw	a2,s2,s1
 a9a:	009a05b3          	add	a1,s4,s1
 a9e:	854e                	mv	a0,s3
 aa0:	00000097          	auipc	ra,0x0
 aa4:	abc080e7          	jalr	-1348(ra) # 55c <read>
 aa8:	00054563          	bltz	a0,ab2 <statistics+0x4e>
      break;
    }
    i += n;
 aac:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 aae:	ff24c4e3          	blt	s1,s2,a96 <statistics+0x32>
  }
  close(fd);
 ab2:	854e                	mv	a0,s3
 ab4:	00000097          	auipc	ra,0x0
 ab8:	ab8080e7          	jalr	-1352(ra) # 56c <close>
  return i;
}
 abc:	8526                	mv	a0,s1
 ...
 acc:	8082                	ret
      fprintf(2, "stats: open failed\n");
 ace:	00000597          	auipc	a1,0x0
 ad2:	0aa58593          	addi	a1,a1,170 # b78 <statistics+0x114>
 ad6:	4509                	li	a0,2
 ad8:	00000097          	auipc	ra,0x0
 adc:	da6080e7          	jalr	-602(ra) # 87e <fprintf>
      exit(1);
 ae0:	4505                	li	a0,1
 ae2:	00000097          	auipc	ra,0x0
 ae6:	a62080e7          	jalr	-1438(ra) # 544 <exit>
