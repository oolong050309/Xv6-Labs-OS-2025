...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	e4250513          	addi	a0,a0,-446 # 5e80 <statistics+0x8c>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	7b078793          	addi	a5,a5,1968 # 9808 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	eb868693          	addi	a3,a3,-328 # bf18 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	e2050513          	addi	a0,a0,-480 # 5ea0 <statistics+0xac>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	e1050513          	addi	a0,a0,-496 # 5eb8 <statistics+0xc4>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	e1250513          	addi	a0,a0,-494 # 5ed8 <statistics+0xe4>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	dda50513          	addi	a0,a0,-550 # 5ec0 <statistics+0xcc>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	de650513          	addi	a0,a0,-538 # 5ee8 <statistics+0xf4>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	de450513          	addi	a0,a0,-540 # 5f10 <statistics+0x11c>
     134:	00005097          	auipc	ra,0x5
     138:	7f0080e7          	jalr	2032(ra) # 5924 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	dd050513          	addi	a0,a0,-560 # 5f10 <statistics+0x11c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	dcc58593          	addi	a1,a1,-564 # 5f20 <statistics+0x12c>
     15c:	00005097          	auipc	ra,0x5
     160:	798080e7          	jalr	1944(ra) # 58f4 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	da850513          	addi	a0,a0,-600 # 5f10 <statistics+0x11c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	dac58593          	addi	a1,a1,-596 # 5f28 <statistics+0x134>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	d7c50513          	addi	a0,a0,-644 # 5f10 <statistics+0x11c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	d6650513          	addi	a0,a0,-666 # 5f30 <statistics+0x13c>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	cdc50513          	addi	a0,a0,-804 # 5f58 <statistics+0x164>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	cc8a8a93          	addi	s5,s5,-824 # 5f58 <statistics+0x164>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	c80a0a13          	addi	s4,s4,-896 # bf18 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	c5650513          	addi	a0,a0,-938 # 5f68 <statistics+0x174>
     ...
     338:	c5450513          	addi	a0,a0,-940 # 5f88 <statistics+0x194>
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	c30a0a13          	addi	s4,s4,-976 # 5fa0 <statistics+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	b8c50513          	addi	a0,a0,-1140 # 5fa8 <statistics+0x1b4>
     ...
     43e:	b8650513          	addi	a0,a0,-1146 # 5fc0 <statistics+0x1cc>
     ...
     45c:	b9850513          	addi	a0,a0,-1128 # 5ff0 <statistics+0x1fc>
     ...
     476:	bae50513          	addi	a0,a0,-1106 # 6020 <statistics+0x22c>
     ...
     494:	ba050513          	addi	a0,a0,-1120 # 6030 <statistics+0x23c>
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	b92a0a13          	addi	s4,s4,-1134 # 6060 <statistics+0x26c>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	a52a8a93          	addi	s5,s5,-1454 # 5f28 <statistics+0x134>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	aec50513          	addi	a0,a0,-1300 # 6068 <statistics+0x274>
     ...
     59e:	ae650513          	addi	a0,a0,-1306 # 6080 <statistics+0x28c>
     ...
     5b8:	a6c50513          	addi	a0,a0,-1428 # 6020 <statistics+0x22c>
     ...
     5d2:	ae250513          	addi	a0,a0,-1310 # 60b0 <statistics+0x2bc>
     ...
     5f0:	adc50513          	addi	a0,a0,-1316 # 60c8 <statistics+0x2d4>
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	8de58593          	addi	a1,a1,-1826 # 5f20 <statistics+0x12c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	8b250513          	addi	a0,a0,-1870 # 5f10 <statistics+0x11c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	88650513          	addi	a0,a0,-1914 # 5f10 <statistics+0x11c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	87250513          	addi	a0,a0,-1934 # 5f10 <statistics+0x11c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	a7c58593          	addi	a1,a1,-1412 # 6158 <statistics+0x364>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	7f250513          	addi	a0,a0,2034 # 5f10 <statistics+0x11c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	99650513          	addi	a0,a0,-1642 # 60f8 <statistics+0x304>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	99a50513          	addi	a0,a0,-1638 # 6118 <statistics+0x324>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     796:	99650513          	addi	a0,a0,-1642 # 6128 <statistics+0x334>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	99a50513          	addi	a0,a0,-1638 # 6148 <statistics+0x354>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c6:	96650513          	addi	a0,a0,-1690 # 6128 <statistics+0x334>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	98050513          	addi	a0,a0,-1664 # 6160 <statistics+0x36c>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	98250513          	addi	a0,a0,-1662 # 6180 <statistics+0x38c>
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	96e50513          	addi	a0,a0,-1682 # 61a0 <statistics+0x3ac>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	97e98993          	addi	s3,s3,-1666 # 61c8 <statistics+0x3d4>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	9aea8a93          	addi	s5,s5,-1618 # 6200 <statistics+0x40c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	90850513          	addi	a0,a0,-1784 # 61a0 <statistics+0x3ac>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	66658593          	addi	a1,a1,1638 # bf18 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	8cc50513          	addi	a0,a0,-1844 # 61a0 <statistics+0x3ac>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	8aa50513          	addi	a0,a0,-1878 # 61a8 <statistics+0x3b4>
    ...
    exit(1);
     ...
     920:	8bc50513          	addi	a0,a0,-1860 # 61d8 <statistics+0x3e4>
     ...
     93e:	8d650513          	addi	a0,a0,-1834 # 6210 <statistics+0x41c>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	8e250513          	addi	a0,a0,-1822 # 6238 <statistics+0x444>
    ...
    printf("%s: read failed\n", s);
     ...
     976:	8e650513          	addi	a0,a0,-1818 # 6258 <statistics+0x464>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	8e250513          	addi	a0,a0,-1822 # 6270 <statistics+0x47c>
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	8d050513          	addi	a0,a0,-1840 # 6290 <statistics+0x49c>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	54490913          	addi	s2,s2,1348 # bf18 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	87e50513          	addi	a0,a0,-1922 # 6290 <statistics+0x49c>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	4f290913          	addi	s2,s2,1266 # bf18 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	83e50513          	addi	a0,a0,-1986 # 6298 <statistics+0x4a4>
    ...
    exit(1);
     ...
     a7c:	84050513          	addi	a0,a0,-1984 # 62b8 <statistics+0x4c4>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	84c50513          	addi	a0,a0,-1972 # 62e0 <statistics+0x4ec>
  ...
  if(unlink("big") < 0){
     ...
     ac4:	7d050513          	addi	a0,a0,2000 # 6290 <statistics+0x49c>
     ...
     af0:	81450513          	addi	a0,a0,-2028 # 6300 <statistics+0x50c>
     ...
     b0e:	81e50513          	addi	a0,a0,-2018 # 6328 <statistics+0x534>
     ...
     b2c:	81850513          	addi	a0,a0,-2024 # 6340 <statistics+0x54c>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	82450513          	addi	a0,a0,-2012 # 6368 <statistics+0x574>
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	80e50513          	addi	a0,a0,-2034 # 6380 <statistics+0x58c>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	82658593          	addi	a1,a1,-2010 # 63b0 <statistics+0x5bc>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	7da50513          	addi	a0,a0,2010 # 6380 <statistics+0x58c>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	7c450513          	addi	a0,a0,1988 # 6380 <statistics+0x58c>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	7ae50513          	addi	a0,a0,1966 # 6380 <statistics+0x58c>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	81258593          	addi	a1,a1,-2030 # 63f8 <statistics+0x604>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	31658593          	addi	a1,a1,790 # bf18 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	73250513          	addi	a0,a0,1842 # 6380 <statistics+0x58c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	72250513          	addi	a0,a0,1826 # 6390 <statistics+0x59c>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	72e50513          	addi	a0,a0,1838 # 63b8 <statistics+0x5c4>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	73250513          	addi	a0,a0,1842 # 63d8 <statistics+0x5e4>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	73e50513          	addi	a0,a0,1854 # 6400 <statistics+0x60c>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	74250513          	addi	a0,a0,1858 # 6420 <statistics+0x62c>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	74650513          	addi	a0,a0,1862 # 6440 <statistics+0x64c>
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	65258593          	addi	a1,a1,1618 # 63b0 <statistics+0x5bc>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	6ea58593          	addi	a1,a1,1770 # 6468 <statistics+0x674>
     d86:	00005517          	auipc	a0,0x5
     d8a:	6da50513          	addi	a0,a0,1754 # 6460 <statistics+0x66c>
  ...
  unlink("lf1");
     ...
     d9e:	6c650513          	addi	a0,a0,1734 # 6460 <statistics+0x66c>
     da2:	00005097          	auipc	ra,0x5
     da6:	b82080e7          	jalr	-1150(ra) # 5924 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	6b450513          	addi	a0,a0,1716 # 6460 <statistics+0x66c>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	6a650513          	addi	a0,a0,1702 # 6468 <statistics+0x674>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	13e58593          	addi	a1,a1,318 # bf18 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	66e58593          	addi	a1,a1,1646 # 6468 <statistics+0x674>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	65850513          	addi	a0,a0,1624 # 6468 <statistics+0x674>
     e18:	00005097          	auipc	ra,0x5
     e1c:	b0c080e7          	jalr	-1268(ra) # 5924 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	64058593          	addi	a1,a1,1600 # 6460 <statistics+0x66c>
     e28:	00005517          	auipc	a0,0x5
     e2c:	64050513          	addi	a0,a0,1600 # 6468 <statistics+0x674>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	62458593          	addi	a1,a1,1572 # 6460 <statistics+0x66c>
     e44:	00005517          	auipc	a0,0x5
     e48:	72c50513          	addi	a0,a0,1836 # 6570 <statistics+0x77c>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	60a50513          	addi	a0,a0,1546 # 6470 <statistics+0x67c>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	60650513          	addi	a0,a0,1542 # 6488 <statistics+0x694>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	60250513          	addi	a0,a0,1538 # 64a0 <statistics+0x6ac>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	60650513          	addi	a0,a0,1542 # 64c0 <statistics+0x6cc>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	61a50513          	addi	a0,a0,1562 # 64f0 <statistics+0x6fc>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	61650513          	addi	a0,a0,1558 # 6508 <statistics+0x714>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	61250513          	addi	a0,a0,1554 # 6520 <statistics+0x72c>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	61e50513          	addi	a0,a0,1566 # 6548 <statistics+0x754>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	63250513          	addi	a0,a0,1586 # 6578 <statistics+0x784>
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	5eca0a13          	addi	s4,s4,1516 # 6598 <statistics+0x7a4>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	59a50513          	addi	a0,a0,1434 # 6598 <statistics+0x7a4>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	53250513          	addi	a0,a0,1330 # 65a0 <statistics+0x7ac>
    ...
    1092:	53250513          	addi	a0,a0,1330 # 65c0 <statistics+0x7cc>
    ...
    10ae:	53650513          	addi	a0,a0,1334 # 65e0 <statistics+0x7ec>
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	52498993          	addi	s3,s3,1316 # 6600 <statistics+0x80c>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	4f850513          	addi	a0,a0,1272 # 6610 <statistics+0x81c>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	b5b48493          	addi	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea1c33>
...
badarg(char *s)
{
    ...
    1184:	35048493          	addi	s1,s1,848 # c350 <buf+0x438>
  for(int i = 0; i < 50000; i++){
    ...
    1192:	d2a98993          	addi	s3,s3,-726 # 5eb8 <statistics+0xc4>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	5f078793          	addi	a5,a5,1520 # 7808 <statistics+0x1a14>
  ...
  if(pid == 0){
    ...
    1252:	5b278793          	addi	a5,a5,1458 # 8800 <big.0>
    1256:	00008697          	auipc	a3,0x8
    125a:	5aa68693          	addi	a3,a3,1450 # 9800 <__global_pointer$+0x90f>
      big[i] = 'x';
    ...
    1270:	58078a23          	sb	zero,1428(a5) # 9800 <__global_pointer$+0x90f>
    char *args2[] = { big, big, big, 0 };
    1274:	00007797          	auipc	a5,0x7
    1278:	00478793          	addi	a5,a5,4 # 8278 <statistics+0x2484>
    ...
    129c:	c2050513          	addi	a0,a0,-992 # 5eb8 <statistics+0xc4>
    ...
    12b4:	40850513          	addi	a0,a0,1032 # 66b8 <statistics+0x8c4>
    ...
    12d4:	36050513          	addi	a0,a0,864 # 6630 <statistics+0x83c>
    ...
    12f4:	36050513          	addi	a0,a0,864 # 6650 <statistics+0x85c>
    ...
    1316:	35e50513          	addi	a0,a0,862 # 6670 <statistics+0x87c>
    ...
    1336:	36650513          	addi	a0,a0,870 # 6698 <statistics+0x8a4>
    ...
    1350:	7e450513          	addi	a0,a0,2020 # 6b30 <statistics+0xd3c>
  ...
  if(st != 747){
    ...
    139a:	34a50513          	addi	a0,a0,842 # 66e0 <statistics+0x8ec>
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	b5050513          	addi	a0,a0,-1200 # 5f10 <statistics+0x11c>
  ...
  if(pid == 0){
    ...
    13f6:	b1ea0a13          	addi	s4,s4,-1250 # 5f10 <statistics+0x11c>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	346a8a93          	addi	s5,s5,838 # 6740 <statistics+0x94c>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    1476:	29e50513          	addi	a0,a0,670 # 6710 <statistics+0x91c>
    ...
    1492:	29a50513          	addi	a0,a0,666 # 6728 <statistics+0x934>
    ...
    14b0:	2a450513          	addi	a0,a0,676 # 6750 <statistics+0x95c>
    ...
    14d6:	a3ea0a13          	addi	s4,s4,-1474 # 5f10 <statistics+0x11c>
    int n = write(fd, "xxx", 3);
    14da:	00005a97          	auipc	s5,0x5
    14de:	296a8a93          	addi	s5,s5,662 # 6770 <statistics+0x97c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1528:	9ec50513          	addi	a0,a0,-1556 # 5f10 <statistics+0x11c>
  ...
  exit(xstatus);
    ...
    1546:	1e650513          	addi	a0,a0,486 # 6728 <statistics+0x934>
    ...
    1564:	21850513          	addi	a0,a0,536 # 6778 <statistics+0x984>
...
000000000000157a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    158a:	93278793          	addi	a5,a5,-1742 # 5eb8 <statistics+0xc4>
    158e:	fcf43023          	sd	a5,-64(s0)
    1592:	00005797          	auipc	a5,0x5
    1596:	20678793          	addi	a5,a5,518 # 6798 <statistics+0x9a4>
    159a:	fcf43423          	sd	a5,-56(s0)
    159e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a2:	00005517          	auipc	a0,0x5
    15a6:	1fe50513          	addi	a0,a0,510 # 67a0 <statistics+0x9ac>
  ...
  if(pid == 0) {
    ...
    15d6:	1ce50513          	addi	a0,a0,462 # 67a0 <statistics+0x9ac>
    ...
    15f2:	1d250513          	addi	a0,a0,466 # 67c0 <statistics+0x9cc>
    ...
    1610:	10450513          	addi	a0,a0,260 # 6710 <statistics+0x91c>
    ...
    162c:	18050513          	addi	a0,a0,384 # 67a8 <statistics+0x9b4>
    ...
    164a:	87250513          	addi	a0,a0,-1934 # 5eb8 <statistics+0xc4>
  ...
  if(xstatus != 0)
    ...
    167e:	15650513          	addi	a0,a0,342 # 67d0 <statistics+0x9dc>
    ...
    169a:	15250513          	addi	a0,a0,338 # 67e8 <statistics+0x9f4>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    16ae:	0f650513          	addi	a0,a0,246 # 67a0 <statistics+0x9ac>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d8:	b8450513          	addi	a0,a0,-1148 # 6258 <statistics+0x464>
    ...
    16f4:	03850513          	addi	a0,a0,56 # 6728 <statistics+0x934>
  ...
  unlink("echo-ok");
    ...
    170e:	09650513          	addi	a0,a0,150 # 67a0 <statistics+0x9ac>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1738:	0cc50513          	addi	a0,a0,204 # 6800 <statistics+0xa0c>
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a0:	77ca8a93          	addi	s5,s5,1916 # bf18 <buf>
    17a4:	864a                	mv	a2,s2
    17a6:	85d6                	mv	a1,s5
    ...
    17bc:	76070713          	addi	a4,a4,1888 # bf18 <buf>
    ...
    1800:	01c50513          	addi	a0,a0,28 # 6818 <statistics+0xa24>
    ...
    182e:	6eeb0b13          	addi	s6,s6,1774 # bf18 <buf>
    ...
    1842:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    188e:	fa650513          	addi	a0,a0,-90 # 6830 <statistics+0xa3c>
    ...
    18aa:	fa250513          	addi	a0,a0,-94 # 6848 <statistics+0xa54>
    ...
    18dc:	f8850513          	addi	a0,a0,-120 # 6860 <statistics+0xa6c>
    ...
    1928:	f5c50513          	addi	a0,a0,-164 # 6880 <statistics+0xa8c>
...
000000000000193e <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    199a:	d7a50513          	addi	a0,a0,-646 # 6710 <statistics+0x91c>
    ...
    19b6:	ee650513          	addi	a0,a0,-282 # 6898 <statistics+0xaa4>
    ...
    19d2:	ee250513          	addi	a0,a0,-286 # 68b0 <statistics+0xabc>
...
00000000000019f2 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a4a:	cca50513          	addi	a0,a0,-822 # 6710 <statistics+0x91c>
    ...
    1a6e:	ca650513          	addi	a0,a0,-858 # 6710 <statistics+0x91c>
...
0000000000001a8c <forkfork>:
{
    ...
    1ae8:	dec50513          	addi	a0,a0,-532 # 68d0 <statistics+0xadc>
    ...
    1afa:	dde080e7          	jalr	-546(ra) # 58d4 <exit>
{
    ...
    1b40:	da450513          	addi	a0,a0,-604 # 68e0 <statistics+0xaec>
...
0000000000001b56 <reparent2>:
{
  ...
  exit(0);
    ...
    1b8e:	fa650513          	addi	a0,a0,-90 # 6b30 <statistics+0xd3c>
...
0000000000001bbe <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c2c:	f0850513          	addi	a0,a0,-248 # 6b30 <statistics+0xd3c>
    ...
    1c58:	b5450513          	addi	a0,a0,-1196 # 67a8 <statistics+0x9b4>
    ...
    1cca:	c3a50513          	addi	a0,a0,-966 # 6900 <statistics+0xb0c>
    ...
    1cfe:	c1e50513          	addi	a0,a0,-994 # 6918 <statistics+0xb24>
    ...
    1d60:	be450513          	addi	a0,a0,-1052 # 6940 <statistics+0xb4c>
...
0000000000001de4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1e04:	12850513          	addi	a0,a0,296 # 5f28 <statistics+0x134>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	e6da0a1b          	addiw	s4,s4,-403 # 41c64e6d <__BSS_END__+0x41c55f45>
    ...
    1e40:	0ecb0b13          	addi	s6,s6,236 # 5f28 <statistics+0x134>
      link("cat", "x");
    1e44:	00005c17          	auipc	s8,0x5
    1e48:	b24c0c13          	addi	s8,s8,-1244 # 6968 <statistics+0xb74>
    1e4c:	a825                	j	1e84 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e4e:	85a6                	mv	a1,s1
    1e50:	00005517          	auipc	a0,0x5
    1e54:	8c050513          	addi	a0,a0,-1856 # 6710 <statistics+0x91c>
...
0000000000001ee8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f4c:	be850513          	addi	a0,a0,-1048 # 6b30 <statistics+0xd3c>
    ...
    1f8e:	f8eb0b13          	addi	s6,s6,-114 # bf18 <buf>
    ...
    2002:	97250513          	addi	a0,a0,-1678 # 6970 <statistics+0xb7c>
    ...
    2022:	f6a50513          	addi	a0,a0,-150 # 5f88 <statistics+0x194>
...
0000000000002040 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2070:	96450513          	addi	a0,a0,-1692 # 69d0 <statistics+0xbdc>
    ...
    2094:	8f850513          	addi	a0,a0,-1800 # 6988 <statistics+0xb94>
    ...
    20b0:	8f450513          	addi	a0,a0,-1804 # 69a0 <statistics+0xbac>
    ...
    20cc:	8f050513          	addi	a0,a0,-1808 # 69b8 <statistics+0xbc4>
...
0000000000002118 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2134:	35098993          	addi	s3,s3,848 # c350 <buf+0x438>
    2138:	1003d937          	lui	s2,0x1003d
    213c:	090e                	slli	s2,s2,0x3
    213e:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e558>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2182:	59250513          	addi	a0,a0,1426 # 6710 <statistics+0x91c>
    ...
    21a4:	85850513          	addi	a0,a0,-1960 # 69f8 <statistics+0xc04>
...
00000000000021c4 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2226:	4ee50513          	addi	a0,a0,1262 # 6710 <statistics+0x91c>
    ...
    2252:	7ca50513          	addi	a0,a0,1994 # 6a18 <statistics+0xc24>
...
0000000000002272 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2282:	7b250513          	addi	a0,a0,1970 # 6a30 <statistics+0xc3c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    22b4:	78050513          	addi	a0,a0,1920 # 6a30 <statistics+0xc3c>
  ...
  close(fd);
    ...
    22da:	42a78793          	addi	a5,a5,1066 # 8700 <args.1>
    22de:	00006697          	auipc	a3,0x6
    22e2:	51a68693          	addi	a3,a3,1306 # 87f8 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22e6:	00004717          	auipc	a4,0x4
    22ea:	75a70713          	addi	a4,a4,1882 # 6a40 <statistics+0xc4c>
    ...
    233e:	7e650513          	addi	a0,a0,2022 # 6b20 <statistics+0xd2c>
    ...
    2362:	7e250513          	addi	a0,a0,2018 # 6b40 <statistics+0xd4c>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    23b6:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff00d8>
    23ba:	85a6                	mv	a1,s1
    23bc:	00004517          	auipc	a0,0x4
    23c0:	7a450513          	addi	a0,a0,1956 # 6b60 <statistics+0xd6c>
    ...
    23dc:	33850513          	addi	a0,a0,824 # 6710 <statistics+0x91c>
...
00000000000023fc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2476:	39678793          	addi	a5,a5,918 # 7808 <statistics+0x1a14>
  ...
  if(ret != -1){
    ...
    24b8:	6d450513          	addi	a0,a0,1748 # 6b88 <statistics+0xd94>
    ...
    24d6:	15e50513          	addi	a0,a0,350 # 6630 <statistics+0x83c>
    ...
    24f4:	16050513          	addi	a0,a0,352 # 6650 <statistics+0x85c>
    ...
    2514:	16050513          	addi	a0,a0,352 # 6670 <statistics+0x87c>
    ...
    2532:	16a50513          	addi	a0,a0,362 # 6698 <statistics+0x8a4>
...
0000000000002548 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    257e:	64e50513          	addi	a0,a0,1614 # 6bc8 <statistics+0xdd4>
  ...
  if(n >= 0){
    ...
    25ae:	63e50513          	addi	a0,a0,1598 # 6be8 <statistics+0xdf4>
    ...
    25cc:	5c850513          	addi	a0,a0,1480 # 6b90 <statistics+0xd9c>
    ...
    25e8:	5c450513          	addi	a0,a0,1476 # 6ba8 <statistics+0xdb4>
    ...
    2602:	5d250513          	addi	a0,a0,1490 # 6bd0 <statistics+0xddc>
  ...
  unlink("rwsbrk");
    ...
    2626:	5a650513          	addi	a0,a0,1446 # 6bc8 <statistics+0xdd4>
    262a:	00003097          	auipc	ra,0x3
    262e:	2fa080e7          	jalr	762(ra) # 5924 <unlink>
  fd = open("README", O_RDONLY);
    2632:	4581                	li	a1,0
    2634:	00004517          	auipc	a0,0x4
    2638:	a2c50513          	addi	a0,a0,-1492 # 6060 <statistics+0x26c>
  ...
  if(n >= 0){
    ...
    2662:	5ba50513          	addi	a0,a0,1466 # 6c18 <statistics+0xe24>
    ...
    267c:	55850513          	addi	a0,a0,1368 # 6bd0 <statistics+0xddc>
...
00000000000026a6 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26e2:	6705                	lui	a4,0x1
      *b = 99;
    26e4:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff10d8>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    2702:	54250513          	addi	a0,a0,1346 # 6c40 <statistics+0xe4c>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2766:	4fe50513          	addi	a0,a0,1278 # 6c60 <statistics+0xe6c>
  ...
  if(c != a + 1){
    ...
    27ca:	4fa50513          	addi	a0,a0,1274 # 6cc0 <statistics+0xecc>
    ...
    27ec:	49850513          	addi	a0,a0,1176 # 6c80 <statistics+0xe8c>
    ...
    2808:	49c50513          	addi	a0,a0,1180 # 6ca0 <statistics+0xeac>
...
0000000000002844 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    28a6:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f10d7>
  a = sbrk(0);
    28aa:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    290a:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f10d7>
  ...
  if(c != a){
    ...
    2952:	39250513          	addi	a0,a0,914 # 6ce0 <statistics+0xeec>
    ...
    296e:	3be50513          	addi	a0,a0,958 # 6d28 <statistics+0xf34>
    ...
    298e:	3be50513          	addi	a0,a0,958 # 6d48 <statistics+0xf54>
    ...
    29ae:	3de50513          	addi	a0,a0,990 # 6d88 <statistics+0xf94>
    ...
    29ca:	3f250513          	addi	a0,a0,1010 # 6db8 <statistics+0xfc4>
    ...
    29ea:	40a50513          	addi	a0,a0,1034 # 6df0 <statistics+0xffc>
...
0000000000002a00 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2a24:	3f850513          	addi	a0,a0,1016 # 6e18 <statistics+0x1024>
    2a28:	00003097          	auipc	ra,0x3
    2a2c:	eec080e7          	jalr	-276(ra) # 5914 <open>
    2a30:	84aa                	mv	s1,a0
  unlink("sbrk");
    2a32:	00004517          	auipc	a0,0x4
    2a36:	3e650513          	addi	a0,a0,998 # 6e18 <statistics+0x1024>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a8a:	39a50513          	addi	a0,a0,922 # 6e20 <statistics+0x102c>
    ...
    2aa6:	39650513          	addi	a0,a0,918 # 6e38 <statistics+0x1044>
    ...
    2ac2:	d5a50513          	addi	a0,a0,-678 # 6818 <statistics+0xa24>
...
0000000000002ad8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2aec:	36850513          	addi	a0,a0,872 # 6e50 <statistics+0x105c>
  ...
  close(fd);
    ...
    2b34:	bf850513          	addi	a0,a0,-1032 # 6728 <statistics+0x934>
...
0000000000002b4a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b82:	fb250513          	addi	a0,a0,-78 # 6b30 <statistics+0xd3c>
  ...
  if(pid == 0){
    ...
    2bd8:	f5c50513          	addi	a0,a0,-164 # 6b30 <statistics+0xd3c>
  ...
  if(pid == 0){
    ...
    2c10:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0xff8>
    ...
    2c38:	efc50513          	addi	a0,a0,-260 # 6b30 <statistics+0xd3c>
...
0000000000002d34 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2d40:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff10dc>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2dac:	d8850513          	addi	a0,a0,-632 # 6b30 <statistics+0xd3c>
    ...
    2e00:	0bc50513          	addi	a0,a0,188 # 5eb8 <statistics+0xc4>
    2e04:	faa43c23          	sd	a0,-72(s0)
    2e08:	00003797          	auipc	a5,0x3
    2e0c:	12078793          	addi	a5,a5,288 # 5f28 <statistics+0x134>
...
0000000000002e2e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2e3e:	1ee50513          	addi	a0,a0,494 # 7028 <statistics+0x1234>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2e50:	03450513          	addi	a0,a0,52 # 6e80 <statistics+0x108c>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e66:	07650513          	addi	a0,a0,118 # 6ed8 <statistics+0x10e4>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e84:	0d050513          	addi	a0,a0,208 # 6f50 <statistics+0x115c>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2ea0:	12450513          	addi	a0,a0,292 # 6fc0 <statistics+0x11cc>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2eb2:	16a50513          	addi	a0,a0,362 # 7018 <statistics+0x1224>
  ...
  unlink("12345678901234");
    ...
    2f30:	f2c50513          	addi	a0,a0,-212 # 6e58 <statistics+0x1064>
    ...
    2f4c:	f5850513          	addi	a0,a0,-168 # 6ea0 <statistics+0x10ac>
    ...
    2f68:	fa450513          	addi	a0,a0,-92 # 6f08 <statistics+0x1114>
    ...
    2fa0:	04450513          	addi	a0,a0,68 # 6fe0 <statistics+0x11ec>
    ...
    2fbc:	08050513          	addi	a0,a0,128 # 7038 <statistics+0x1244>
...
0000000000002fd2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2fe2:	09250513          	addi	a0,a0,146 # 7070 <statistics+0x127c>
  ...
  if(chdir("iputdir") < 0){
    ...
    2ff6:	07e50513          	addi	a0,a0,126 # 7070 <statistics+0x127c>
  ...
  if(unlink("../iputdir") < 0){
    ...
    300a:	0aa50513          	addi	a0,a0,170 # 70b0 <statistics+0x12bc>
  ...
  if(chdir("/") < 0){
    ...
    301e:	0c650513          	addi	a0,a0,198 # 70e0 <statistics+0x12ec>
    ...
    303e:	03e50513          	addi	a0,a0,62 # 7078 <statistics+0x1284>
    ...
    305a:	03a50513          	addi	a0,a0,58 # 7090 <statistics+0x129c>
    ...
    3076:	04e50513          	addi	a0,a0,78 # 70c0 <statistics+0x12cc>
    ...
    3092:	05a50513          	addi	a0,a0,90 # 70e8 <statistics+0x12f4>
...
00000000000030a8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    30c6:	fae50513          	addi	a0,a0,-82 # 7070 <statistics+0x127c>
    ...
    30da:	f9a50513          	addi	a0,a0,-102 # 7070 <statistics+0x127c>
    ...
    30ee:	fc650513          	addi	a0,a0,-58 # 70b0 <statistics+0x12bc>
    ...
    310e:	60650513          	addi	a0,a0,1542 # 6710 <statistics+0x91c>
    ...
    312a:	f5250513          	addi	a0,a0,-174 # 7078 <statistics+0x1284>
    ...
    3146:	fbe50513          	addi	a0,a0,-66 # 7100 <statistics+0x130c>
    ...
    3162:	f6250513          	addi	a0,a0,-158 # 70c0 <statistics+0x12cc>
...
0000000000003190 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    31a0:	f7c50513          	addi	a0,a0,-132 # 7118 <statistics+0x1324>
  ...
  if(chdir("dir0") < 0){
    ...
    31b4:	f6850513          	addi	a0,a0,-152 # 7118 <statistics+0x1324>
  ...
  if(chdir("..") < 0){
    ...
    31c8:	f7450513          	addi	a0,a0,-140 # 7138 <statistics+0x1344>
  ...
  if(unlink("dir0") < 0){
    ...
    31dc:	f4050513          	addi	a0,a0,-192 # 7118 <statistics+0x1324>
    ...
    31fc:	e8050513          	addi	a0,a0,-384 # 7078 <statistics+0x1284>
    ...
    3218:	f0c50513          	addi	a0,a0,-244 # 7120 <statistics+0x132c>
    ...
    3234:	f1050513          	addi	a0,a0,-240 # 7140 <statistics+0x134c>
    ...
    3250:	f0c50513          	addi	a0,a0,-244 # 7158 <statistics+0x1364>
...
0000000000003266 <subdir>:
{
  ...
  unlink("ff");
    ...
    3278:	02c50513          	addi	a0,a0,44 # 72a0 <statistics+0x14ac>
    327c:	00002097          	auipc	ra,0x2
    3280:	6a8080e7          	jalr	1704(ra) # 5924 <unlink>
  if(mkdir("dd") != 0){
    3284:	00004517          	auipc	a0,0x4
    3288:	eec50513          	addi	a0,a0,-276 # 7170 <statistics+0x137c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	ef450513          	addi	a0,a0,-268 # 7190 <statistics+0x139c>
  ...
  write(fd, "ff", 2);
    ...
    32b8:	fec58593          	addi	a1,a1,-20 # 72a0 <statistics+0x14ac>
  ...
  if(unlink("dd") >= 0){
    ...
    32d2:	ea250513          	addi	a0,a0,-350 # 7170 <statistics+0x137c>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    32e6:	f0650513          	addi	a0,a0,-250 # 71e8 <statistics+0x13f4>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32fe:	f1650513          	addi	a0,a0,-234 # 7210 <statistics+0x141c>
  ...
  write(fd, "FF", 2);
    ...
    3316:	f2e58593          	addi	a1,a1,-210 # 7240 <statistics+0x144c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3332:	f1a50513          	addi	a0,a0,-230 # 7248 <statistics+0x1454>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    334a:	bd258593          	addi	a1,a1,-1070 # bf18 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3360:	bbc74703          	lbu	a4,-1092(a4) # bf18 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    337a:	f2258593          	addi	a1,a1,-222 # 7298 <statistics+0x14a4>
    337e:	00004517          	auipc	a0,0x4
    3382:	e9250513          	addi	a0,a0,-366 # 7210 <statistics+0x141c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3396:	e7e50513          	addi	a0,a0,-386 # 7210 <statistics+0x141c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ac:	e6850513          	addi	a0,a0,-408 # 7210 <statistics+0x141c>
  ...
  if(chdir("dd") != 0){
    ...
    33c0:	db450513          	addi	a0,a0,-588 # 7170 <statistics+0x137c>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    33d4:	f6050513          	addi	a0,a0,-160 # 7330 <statistics+0x153c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    33e8:	f7c50513          	addi	a0,a0,-132 # 7360 <statistics+0x156c>
  ...
  if(chdir("./..") != 0){
    ...
    33fc:	f9850513          	addi	a0,a0,-104 # 7390 <statistics+0x159c>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3412:	e8a50513          	addi	a0,a0,-374 # 7298 <statistics+0x14a4>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    342a:	af258593          	addi	a1,a1,-1294 # bf18 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    344c:	dc850513          	addi	a0,a0,-568 # 7210 <statistics+0x141c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3464:	fc050513          	addi	a0,a0,-64 # 7420 <statistics+0x162c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    347c:	fd850513          	addi	a0,a0,-40 # 7450 <statistics+0x165c>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3494:	ce050513          	addi	a0,a0,-800 # 7170 <statistics+0x137c>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    34aa:	cca50513          	addi	a0,a0,-822 # 7170 <statistics+0x137c>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    34c0:	cb450513          	addi	a0,a0,-844 # 7170 <statistics+0x137c>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    34d4:	01058593          	addi	a1,a1,16 # 74e0 <statistics+0x16ec>
    34d8:	00004517          	auipc	a0,0x4
    34dc:	f4850513          	addi	a0,a0,-184 # 7420 <statistics+0x162c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34f0:	ff458593          	addi	a1,a1,-12 # 74e0 <statistics+0x16ec>
    34f4:	00004517          	auipc	a0,0x4
    34f8:	f5c50513          	addi	a0,a0,-164 # 7450 <statistics+0x165c>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    350c:	d9058593          	addi	a1,a1,-624 # 7298 <statistics+0x14a4>
    3510:	00004517          	auipc	a0,0x4
    3514:	c8050513          	addi	a0,a0,-896 # 7190 <statistics+0x139c>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3528:	efc50513          	addi	a0,a0,-260 # 7420 <statistics+0x162c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    353c:	f1850513          	addi	a0,a0,-232 # 7450 <statistics+0x165c>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3550:	d4c50513          	addi	a0,a0,-692 # 7298 <statistics+0x14a4>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3564:	ef050513          	addi	a0,a0,-272 # 7450 <statistics+0x165c>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3578:	eac50513          	addi	a0,a0,-340 # 7420 <statistics+0x162c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    358c:	c0850513          	addi	a0,a0,-1016 # 7190 <statistics+0x139c>
  ...
  if(chdir("dd/xx") == 0){
    ...
    35a0:	09450513          	addi	a0,a0,148 # 7630 <statistics+0x183c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    35b4:	ce850513          	addi	a0,a0,-792 # 7298 <statistics+0x14a4>
  ...
  if(unlink("dd/ff") != 0){
    ...
    35c8:	bcc50513          	addi	a0,a0,-1076 # 7190 <statistics+0x139c>
  ...
  if(unlink("dd") == 0){
    ...
    35dc:	b9850513          	addi	a0,a0,-1128 # 7170 <statistics+0x137c>
  ...
  if(unlink("dd/dd") < 0){
    ...
    35f0:	0b450513          	addi	a0,a0,180 # 76a0 <statistics+0x18ac>
  ...
  if(unlink("dd") < 0){
    ...
    3604:	b7050513          	addi	a0,a0,-1168 # 7170 <statistics+0x137c>
    ...
    3626:	b5650513          	addi	a0,a0,-1194 # 7178 <statistics+0x1384>
    ...
    3642:	b5a50513          	addi	a0,a0,-1190 # 7198 <statistics+0x13a4>
    ...
    365e:	b5e50513          	addi	a0,a0,-1186 # 71b8 <statistics+0x13c4>
    ...
    367a:	b7a50513          	addi	a0,a0,-1158 # 71f0 <statistics+0x13fc>
    ...
    3696:	b8e50513          	addi	a0,a0,-1138 # 7220 <statistics+0x142c>
    ...
    36b2:	baa50513          	addi	a0,a0,-1110 # 7258 <statistics+0x1464>
    ...
    36ce:	bae50513          	addi	a0,a0,-1106 # 7278 <statistics+0x1484>
    ...
    36ea:	bc250513          	addi	a0,a0,-1086 # 72a8 <statistics+0x14b4>
    ...
    3706:	bce50513          	addi	a0,a0,-1074 # 72d0 <statistics+0x14dc>
    ...
    3722:	bd250513          	addi	a0,a0,-1070 # 72f0 <statistics+0x14fc>
    ...
    373e:	bde50513          	addi	a0,a0,-1058 # 7318 <statistics+0x1524>
    ...
    375a:	bea50513          	addi	a0,a0,-1046 # 7340 <statistics+0x154c>
    ...
    3776:	bfe50513          	addi	a0,a0,-1026 # 7370 <statistics+0x157c>
    ...
    3792:	c0a50513          	addi	a0,a0,-1014 # 7398 <statistics+0x15a4>
    ...
    37ae:	c0650513          	addi	a0,a0,-1018 # 73b0 <statistics+0x15bc>
    ...
    37ca:	c0a50513          	addi	a0,a0,-1014 # 73d0 <statistics+0x15dc>
    ...
    37e6:	c0e50513          	addi	a0,a0,-1010 # 73f0 <statistics+0x15fc>
    ...
    3802:	c3250513          	addi	a0,a0,-974 # 7430 <statistics+0x163c>
    ...
    381e:	c4650513          	addi	a0,a0,-954 # 7460 <statistics+0x166c>
    ...
    383a:	c4a50513          	addi	a0,a0,-950 # 7480 <statistics+0x168c>
    ...
    3856:	c4e50513          	addi	a0,a0,-946 # 74a0 <statistics+0x16ac>
    ...
    3872:	c5250513          	addi	a0,a0,-942 # 74c0 <statistics+0x16cc>
    ...
    388e:	c6650513          	addi	a0,a0,-922 # 74f0 <statistics+0x16fc>
    ...
    38aa:	c7250513          	addi	a0,a0,-910 # 7518 <statistics+0x1724>
    ...
    38c6:	c7e50513          	addi	a0,a0,-898 # 7540 <statistics+0x174c>
    ...
    38e2:	c8a50513          	addi	a0,a0,-886 # 7568 <statistics+0x1774>
    ...
    38fe:	c8e50513          	addi	a0,a0,-882 # 7588 <statistics+0x1794>
    ...
    391a:	c9250513          	addi	a0,a0,-878 # 75a8 <statistics+0x17b4>
    ...
    3936:	c9e50513          	addi	a0,a0,-866 # 75d0 <statistics+0x17dc>
    ...
    3952:	ca250513          	addi	a0,a0,-862 # 75f0 <statistics+0x17fc>
    ...
    396e:	ca650513          	addi	a0,a0,-858 # 7610 <statistics+0x181c>
    ...
    398a:	cb250513          	addi	a0,a0,-846 # 7638 <statistics+0x1844>
    ...
    39a6:	92e50513          	addi	a0,a0,-1746 # 72d0 <statistics+0x14dc>
    ...
    39c2:	c9a50513          	addi	a0,a0,-870 # 7658 <statistics+0x1864>
    ...
    39de:	c9e50513          	addi	a0,a0,-866 # 7678 <statistics+0x1884>
    ...
    39fa:	cb250513          	addi	a0,a0,-846 # 76a8 <statistics+0x18b4>
    ...
    3a16:	cb650513          	addi	a0,a0,-842 # 76c8 <statistics+0x18d4>
...
0000000000003a2c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3a3c:	ca850513          	addi	a0,a0,-856 # 76e0 <statistics+0x18ec>
  ...
  if(chdir("dots") != 0){
    ...
    3a4e:	c9650513          	addi	a0,a0,-874 # 76e0 <statistics+0x18ec>
  ...
  if(unlink(".") == 0){
    ...
    3a60:	b1450513          	addi	a0,a0,-1260 # 6570 <statistics+0x77c>
  ...
  if(unlink("..") == 0){
    ...
    3a72:	6ca50513          	addi	a0,a0,1738 # 7138 <statistics+0x1344>
  ...
  if(chdir("/") != 0){
    ...
    3a84:	66050513          	addi	a0,a0,1632 # 70e0 <statistics+0x12ec>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a96:	cb650513          	addi	a0,a0,-842 # 7748 <statistics+0x1954>
  ...
  if(unlink("dots/..") == 0){
    ...
    3aa8:	ccc50513          	addi	a0,a0,-820 # 7770 <statistics+0x197c>
  ...
  if(unlink("dots") != 0){
    ...
    3aba:	c2a50513          	addi	a0,a0,-982 # 76e0 <statistics+0x18ec>
    ...
    3ad8:	c1450513          	addi	a0,a0,-1004 # 76e8 <statistics+0x18f4>
    ...
    3af4:	c1050513          	addi	a0,a0,-1008 # 7700 <statistics+0x190c>
    ...
    3b10:	c0c50513          	addi	a0,a0,-1012 # 7718 <statistics+0x1924>
    ...
    3b2c:	c0850513          	addi	a0,a0,-1016 # 7730 <statistics+0x193c>
    ...
    3b48:	5a450513          	addi	a0,a0,1444 # 70e8 <statistics+0x12f4>
    ...
    3b64:	bf050513          	addi	a0,a0,-1040 # 7750 <statistics+0x195c>
    ...
    3b80:	bfc50513          	addi	a0,a0,-1028 # 7778 <statistics+0x1984>
    ...
    3b9c:	c0050513          	addi	a0,a0,-1024 # 7798 <statistics+0x19a4>
...
0000000000003bb2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3bc8:	bf450513          	addi	a0,a0,-1036 # 77b8 <statistics+0x19c4>
  ...
  if(chdir("dirfile") == 0){
    ...
    3be4:	bd850513          	addi	a0,a0,-1064 # 77b8 <statistics+0x19c4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3bf8:	c0c50513          	addi	a0,a0,-1012 # 7800 <statistics+0x1a0c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3c10:	bf450513          	addi	a0,a0,-1036 # 7800 <statistics+0x1a0c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3c24:	be050513          	addi	a0,a0,-1056 # 7800 <statistics+0x1a0c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3c38:	bcc50513          	addi	a0,a0,-1076 # 7800 <statistics+0x1a0c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3c4c:	bb858593          	addi	a1,a1,-1096 # 7800 <statistics+0x1a0c>
    3c50:	00002517          	auipc	a0,0x2
    3c54:	41050513          	addi	a0,a0,1040 # 6060 <statistics+0x26c>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c68:	b5450513          	addi	a0,a0,-1196 # 77b8 <statistics+0x19c4>
  ...
  fd = open(".", O_RDWR);
    ...
    3c7e:	8f650513          	addi	a0,a0,-1802 # 6570 <statistics+0x77c>
  ...
  fd = open(".", 0);
    ...
    3c94:	8e050513          	addi	a0,a0,-1824 # 6570 <statistics+0x77c>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3ca8:	28458593          	addi	a1,a1,644 # 5f28 <statistics+0x134>
  ...
  close(fd);
    ...
    3cd4:	af050513          	addi	a0,a0,-1296 # 77c0 <statistics+0x19cc>
    ...
    3cf0:	af450513          	addi	a0,a0,-1292 # 77e0 <statistics+0x19ec>
    ...
    3d0c:	b0850513          	addi	a0,a0,-1272 # 7810 <statistics+0x1a1c>
    ...
    3d28:	aec50513          	addi	a0,a0,-1300 # 7810 <statistics+0x1a1c>
    ...
    3d44:	af850513          	addi	a0,a0,-1288 # 7838 <statistics+0x1a44>
    ...
    3d60:	b0450513          	addi	a0,a0,-1276 # 7860 <statistics+0x1a6c>
    ...
    3d7c:	b1050513          	addi	a0,a0,-1264 # 7888 <statistics+0x1a94>
    ...
    3d98:	b1c50513          	addi	a0,a0,-1252 # 78b0 <statistics+0x1abc>
    ...
    3db4:	b2050513          	addi	a0,a0,-1248 # 78d0 <statistics+0x1adc>
    ...
    3dd0:	b2c50513          	addi	a0,a0,-1236 # 78f8 <statistics+0x1b04>
...
0000000000003de6 <iref>:
{
    ...
    3e04:	b10a0a13          	addi	s4,s4,-1264 # 7910 <statistics+0x1b1c>
    mkdir("");
    3e08:	00003497          	auipc	s1,0x3
    3e0c:	61048493          	addi	s1,s1,1552 # 7418 <statistics+0x1624>
    link("README", "");
    3e10:	00002a97          	auipc	s5,0x2
    3e14:	250a8a93          	addi	s5,s5,592 # 6060 <statistics+0x26c>
    fd = open("xx", O_CREATE);
    3e18:	00004997          	auipc	s3,0x4
    3e1c:	9f098993          	addi	s3,s3,-1552 # 7808 <statistics+0x1a14>
    3e20:	a891                	j	3e74 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3e22:	85da                	mv	a1,s6
    3e24:	00004517          	auipc	a0,0x4
    3e28:	af450513          	addi	a0,a0,-1292 # 7918 <statistics+0x1b24>
    ...
    3e44:	af050513          	addi	a0,a0,-1296 # 7930 <statistics+0x1b3c>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3ed8:	26498993          	addi	s3,s3,612 # 7138 <statistics+0x1344>
    unlink("irefd");
    3edc:	00004917          	auipc	s2,0x4
    3ee0:	a3490913          	addi	s2,s2,-1484 # 7910 <statistics+0x1b1c>
    chdir("..");
    3ee4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3f00:	1e450513          	addi	a0,a0,484 # 70e0 <statistics+0x12ec>
...
0000000000003f20 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3f30:	a1c50513          	addi	a0,a0,-1508 # 7948 <statistics+0x1b54>
  ...
  if(pid == 0){
    ...
    3f54:	9f850513          	addi	a0,a0,-1544 # 7948 <statistics+0x1b54>
    ...
    3f6a:	a0250513          	addi	a0,a0,-1534 # 7968 <statistics+0x1b74>
    ...
    3f86:	9ce50513          	addi	a0,a0,-1586 # 7950 <statistics+0x1b5c>
    ...
    3fa2:	77250513          	addi	a0,a0,1906 # 6710 <statistics+0x91c>
  ...
  if(unlink("oidir") != 0){
    ...
    3fd0:	97c50513          	addi	a0,a0,-1668 # 7948 <statistics+0x1b54>
    ...
    3fe4:	92050513          	addi	a0,a0,-1760 # 6900 <statistics+0xb0c>
...
0000000000004012 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4022:	97250513          	addi	a0,a0,-1678 # 7990 <statistics+0x1b9c>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    404e:	94650513          	addi	a0,a0,-1722 # 7990 <statistics+0x1b9c>
  ...
  sleep(10); // one second
    ...
    printf("%s: fork failed", s);
    4080:	85a6                	mv	a1,s1
    4082:	00003517          	auipc	a0,0x3
    4086:	84e50513          	addi	a0,a0,-1970 # 68d0 <statistics+0xadc>
    ...
    40a0:	8f448493          	addi	s1,s1,-1804 # 7990 <statistics+0x1b9c>
    40a4:	4581                	li	a1,0
    40a6:	8526                	mv	a0,s1
    ...
    40c8:	8cc50513          	addi	a0,a0,-1844 # 7990 <statistics+0x1b9c>
...
00000000000040e8 <killstatus>:
{
  ...
  exit(0);
    ...
    414e:	5c650513          	addi	a0,a0,1478 # 6710 <statistics+0x91c>
    ...
    4174:	83050513          	addi	a0,a0,-2000 # 79a0 <statistics+0x1bac>
...
000000000000418a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    41b4:	72050513          	addi	a0,a0,1824 # 68d0 <statistics+0xadc>
  ...
  if(pid2 == 0)
    ...
    41e2:	53250513          	addi	a0,a0,1330 # 6710 <statistics+0x91c>
  ...
  if(pid3 == 0){
    ...
    4226:	d0658593          	addi	a1,a1,-762 # 5f28 <statistics+0x134>
    ...
    4250:	4c450513          	addi	a0,a0,1220 # 6710 <statistics+0x91c>
    ...
    426c:	75850513          	addi	a0,a0,1880 # 79c0 <statistics+0x1bcc>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    428c:	c9058593          	addi	a1,a1,-880 # bf18 <buf>
    ...
    42a8:	73450513          	addi	a0,a0,1844 # 79d8 <statistics+0x1be4>
  ...
  printf("kill... ");
    ...
    42d4:	72050513          	addi	a0,a0,1824 # 79f0 <statistics+0x1bfc>
  ...
  printf("wait... ");
    ...
    4302:	70250513          	addi	a0,a0,1794 # 7a00 <statistics+0x1c0c>
...
000000000000432e <reparent>:
{
  ...
  exit(0);
    ...
    4382:	39250513          	addi	a0,a0,914 # 6710 <statistics+0x91c>
    ...
    439e:	4fe50513          	addi	a0,a0,1278 # 6898 <statistics+0xaa4>
...
00000000000043de <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4414:	40850513          	addi	a0,a0,1032 # 6818 <statistics+0xa24>
    ...
    4448:	ae458593          	addi	a1,a1,-1308 # 5f28 <statistics+0x134>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    450c:	50850513          	addi	a0,a0,1288 # 7a10 <statistics+0x1c1c>
    ...
    4528:	1ec50513          	addi	a0,a0,492 # 6710 <statistics+0x91c>
    ...
    455e:	6705                	lui	a4,0x1
      n += *(a+i);
    4560:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f10d8>
    ...
    4574:	4c050513          	addi	a0,a0,1216 # 7a30 <statistics+0x1c3c>
...
0000000000004594 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4618:	44c50513          	addi	a0,a0,1100 # 7a60 <statistics+0x1c6c>
...
0000000000004638 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    46da:	3ba50513          	addi	a0,a0,954 # 7a90 <statistics+0x1c9c>
    ...
    46f6:	3c650513          	addi	a0,a0,966 # 7ab8 <statistics+0x1cc4>
  ...
  fd = open("sharedfd", 0);
    ...
    473a:	34a50513          	addi	a0,a0,842 # 7a80 <statistics+0x1c8c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    477a:	36250513          	addi	a0,a0,866 # 7ad8 <statistics+0x1ce4>
  ...
  unlink("sharedfd");
    ...
    47b6:	2ce50513          	addi	a0,a0,718 # 7a80 <statistics+0x1c8c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    47dc:	32850513          	addi	a0,a0,808 # 7b00 <statistics+0x1d0c>
...
00000000000047fc <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4820:	2fc78793          	addi	a5,a5,764 # 7b18 <statistics+0x1d24>
    4824:	f6f43823          	sd	a5,-144(s0)
    4828:	00003797          	auipc	a5,0x3
    482c:	2f878793          	addi	a5,a5,760 # 7b20 <statistics+0x1d2c>
    4830:	f6f43c23          	sd	a5,-136(s0)
    4834:	00003797          	auipc	a5,0x3
    4838:	2f478793          	addi	a5,a5,756 # 7b28 <statistics+0x1d34>
    483c:	f8f43023          	sd	a5,-128(s0)
    4840:	00003797          	auipc	a5,0x3
    4844:	2f078793          	addi	a5,a5,752 # 7b30 <statistics+0x1d3c>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    489c:	680a0a13          	addi	s4,s4,1664 # bf18 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    48b2:	28250513          	addi	a0,a0,642 # 6b30 <statistics+0xd3c>
    ...
    492c:	21050513          	addi	a0,a0,528 # 7b38 <statistics+0x1d44>
    ...
    4946:	20650513          	addi	a0,a0,518 # 7b48 <statistics+0x1d54>
    ...
    496c:	1f850513          	addi	a0,a0,504 # 7b60 <statistics+0x1d6c>
    ...
    499c:	58078793          	addi	a5,a5,1408 # bf18 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49f4:	18050513          	addi	a0,a0,384 # 7b70 <statistics+0x1d7c>
...
0000000000004a28 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a56:	136b8b93          	addi	s7,s7,310 # 7b88 <statistics+0x1d94>
  for(i = 0; i < N; i++){
    ...
    4a98:	0fc50513          	addi	a0,a0,252 # 7b90 <statistics+0x1d9c>
    ...
    4ab6:	0d650513          	addi	a0,a0,214 # 7b88 <statistics+0x1d94>
  ...
  fd = open(".", 0);
    ...
    4aee:	a8650513          	addi	a0,a0,-1402 # 6570 <statistics+0x77c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b66:	04e50513          	addi	a0,a0,78 # 7bb0 <statistics+0x1dbc>
    ...
    4b86:	04e50513          	addi	a0,a0,78 # 7bd0 <statistics+0x1ddc>
  ...
  for(i = 0; i < N; i++){
    ...
    4bbe:	03e50513          	addi	a0,a0,62 # 7bf8 <statistics+0x1e04>
    ...
    4bda:	b3a50513          	addi	a0,a0,-1222 # 6710 <statistics+0x91c>
...
0000000000004d84 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4dc4:	15890913          	addi	s2,s2,344 # bf18 <buf>
  for(i = 0; i < N; i++){
    4dc8:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4e0c:	e2850513          	addi	a0,a0,-472 # 7c30 <statistics+0x1e3c>
  ...
  for(i = 0; ; i++){
    ...
    4e22:	0fa90913          	addi	s2,s2,250 # bf18 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e70:	dd450513          	addi	a0,a0,-556 # 7c40 <statistics+0x1e4c>
    ...
    4e8c:	dd850513          	addi	a0,a0,-552 # 7c60 <statistics+0x1e6c>
    ...
    4ea8:	ddc50513          	addi	a0,a0,-548 # 7c80 <statistics+0x1e8c>
    ...
    4ec4:	de050513          	addi	a0,a0,-544 # 7ca0 <statistics+0x1eac>
    ...
    4ee0:	de450513          	addi	a0,a0,-540 # 7cc0 <statistics+0x1ecc>
    ...
    4efc:	de050513          	addi	a0,a0,-544 # 7cd8 <statistics+0x1ee4>
  ...
  unlink("bigfile.dat");
    ...
    4f2a:	d0a50513          	addi	a0,a0,-758 # 7c30 <statistics+0x1e3c>
    ...
    4f4e:	dae50513          	addi	a0,a0,-594 # 7cf8 <statistics+0x1f04>
...
0000000000004f64 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f84:	d9850513          	addi	a0,a0,-616 # 7d18 <statistics+0x1f24>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fa4:	d88c8c93          	addi	s9,s9,-632 # 7d28 <statistics+0x1f34>
    name[0] = 'f';
    ...
    5014:	d2850513          	addi	a0,a0,-728 # 7d38 <statistics+0x1f44>
  ...
  printf("fsfull test finished\n");
    ...
    508a:	cd250513          	addi	a0,a0,-814 # 7d58 <statistics+0x1f64>
    ...
    50b8:	e64a8a93          	addi	s5,s5,-412 # bf18 <buf>
      if(cc < BSIZE)
    ...
    50e0:	c6c50513          	addi	a0,a0,-916 # 7d48 <statistics+0x1f54>
...
00000000000050fe <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5172:	c0250513          	addi	a0,a0,-1022 # 7d70 <statistics+0x1f7c>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    518a:	da258593          	addi	a1,a1,-606 # 5f28 <statistics+0x134>
    ...
    51a0:	bf450513          	addi	a0,a0,-1036 # 7d90 <statistics+0x1f9c>
    ...
    51ba:	bc250513          	addi	a0,a0,-1086 # 7d78 <statistics+0x1f84>
    ...
    51d4:	ba850513          	addi	a0,a0,-1112 # 7d78 <statistics+0x1f84>
  ...
  unlink("junk");
    ...
    51f8:	b7c50513          	addi	a0,a0,-1156 # 7d70 <statistics+0x1f7c>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    524e:	cde98993          	addi	s3,s3,-802 # 5f28 <statistics+0x134>
      uint64 a = (uint64) sbrk(4096);
    ...
    5280:	b6450513          	addi	a0,a0,-1180 # 7de0 <statistics+0x1fec>
    ...
    52a0:	b0450513          	addi	a0,a0,-1276 # 7da0 <statistics+0x1fac>
    ...
    52c0:	b0450513          	addi	a0,a0,-1276 # 7dc0 <statistics+0x1fcc>
  ...
  while(1){
    ...
    5314:	af050513          	addi	a0,a0,-1296 # 7e00 <statistics+0x200c>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5360:	ac450513          	addi	a0,a0,-1340 # 7e20 <statistics+0x202c>
  ...
  if(pid == 0) {
    ...
    5390:	abc50513          	addi	a0,a0,-1348 # 7e48 <statistics+0x2054>
    ...
    53b4:	a8050513          	addi	a0,a0,-1408 # 7e30 <statistics+0x203c>
    ...
    53dc:	a7850513          	addi	a0,a0,-1416 # 7e50 <statistics+0x205c>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5426:	e7678793          	addi	a5,a5,-394 # 8298 <statistics+0x24a4>
    542a:	bd040713          	addi	a4,s0,-1072
    542e:	00003317          	auipc	t1,0x3
    5432:	25a30313          	addi	t1,t1,602 # 8688 <statistics+0x2894>
  ...
  printf("usertests starting\n");
    ...
    5466:	aae50513          	addi	a0,a0,-1362 # 7f10 <statistics+0x211c>
  ...
  if(fail){
    ...
    54a0:	a2c50513          	addi	a0,a0,-1492 # 7ec8 <statistics+0x20d4>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54d0:	98c58593          	addi	a1,a1,-1652 # 7e58 <statistics+0x2064>
    ...
    54e6:	db678793          	addi	a5,a5,-586 # 8298 <statistics+0x24a4>
    54ea:	bd040713          	addi	a4,s0,-1072
    54ee:	00003317          	auipc	t1,0x3
    54f2:	19a30313          	addi	t1,t1,410 # 8688 <statistics+0x2894>
    ...
    5526:	a0650513          	addi	a0,a0,-1530 # 7f28 <statistics+0x2134>
    552a:	00000097          	auipc	ra,0x0
    552e:	712080e7          	jalr	1810(ra) # 5c3c <printf>
        printf("SOME TESTS FAILED\n");
    5532:	00003a97          	auipc	s5,0x3
    5536:	97ea8a93          	addi	s5,s5,-1666 # 7eb0 <statistics+0x20bc>
        if(continuous != 2)
    553a:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    553c:	00003b17          	auipc	s6,0x3
    5540:	954b0b13          	addi	s6,s6,-1708 # 7e90 <statistics+0x209c>
    5544:	a8f5                	j	5640 <main+0x256>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    5546:	00003597          	auipc	a1,0x3
    554a:	91a58593          	addi	a1,a1,-1766 # 7e60 <statistics+0x206c>
    ...
    5584:	8e850513          	addi	a0,a0,-1816 # 7e68 <statistics+0x2074>
  ...
  if(fail){
    ...
    55f6:	8be50513          	addi	a0,a0,-1858 # 7eb0 <statistics+0x20bc>
    ...
    5610:	8ec50513          	addi	a0,a0,-1812 # 7ef8 <statistics+0x2104>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    59b8:	d2c50513          	addi	a0,a0,-724 # 86e0 <digits>
    59bc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5abe:	bce70713          	addi	a4,a4,-1074 # 8688 <statistics+0x2894>
  ...
  putc(fd, 'x');
    ...
    5b4a:	b9ab8b93          	addi	s7,s7,-1126 # 86e0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ba0:	6ac90913          	addi	s2,s2,1708 # 8248 <statistics+0x2454>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c7c:	00003797          	auipc	a5,0x3
    5c80:	a7c7b783          	ld	a5,-1412(a5) # 86f8 <freep>
    ...
    5ca8:	00e6ea63          	bltu	a3,a4,5cbc <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    5ce6:	00003717          	auipc	a4,0x3
    5cea:	a0f73923          	sd	a5,-1518(a4) # 86f8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5d14:	9e853503          	ld	a0,-1560(a0) # 86f8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    5d40:	00003917          	auipc	s2,0x3
    5d44:	9b890913          	addi	s2,s2,-1608 # 86f8 <freep>
  if(p == (char*)-1)
    5d48:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    5d54:	00009797          	auipc	a5,0x9
    5d58:	1c478793          	addi	a5,a5,452 # ef18 <base>
    5d5c:	00003717          	auipc	a4,0x3
    5d60:	98f73e23          	sd	a5,-1636(a4) # 86f8 <freep>
  ...
  if(p == (char*)-1)
    ...
    5dce:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5dd2:	00003717          	auipc	a4,0x3
    5dd6:	92a73323          	sd	a0,-1754(a4) # 86f8 <freep>
      return (void*)(p + 1);
...
{
    5df4:	7179                	addi	sp,sp,-48
    5df6:	f406                	sd	ra,40(sp)
    5df8:	f022                	sd	s0,32(sp)
    5dfa:	ec26                	sd	s1,24(sp)
    5dfc:	e84a                	sd	s2,16(sp)
    5dfe:	e44e                	sd	s3,8(sp)
    5e00:	e052                	sd	s4,0(sp)
    5e02:	1800                	addi	s0,sp,48
    5e04:	8a2a                	mv	s4,a0
    5e06:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    5e08:	4581                	li	a1,0
    5e0a:	00002517          	auipc	a0,0x2
    5e0e:	44650513          	addi	a0,a0,1094 # 8250 <statistics+0x245c>
    5e12:	00000097          	auipc	ra,0x0
    5e16:	b02080e7          	jalr	-1278(ra) # 5914 <open>
  if(fd < 0) {
    5e1a:	04054263          	bltz	a0,5e5e <statistics+0x6a>
    5e1e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    5e20:	4481                	li	s1,0
    5e22:	03205063          	blez	s2,5e42 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    5e26:	4099063b          	subw	a2,s2,s1
    5e2a:	009a05b3          	add	a1,s4,s1
    5e2e:	854e                	mv	a0,s3
    5e30:	00000097          	auipc	ra,0x0
    5e34:	abc080e7          	jalr	-1348(ra) # 58ec <read>
    5e38:	00054563          	bltz	a0,5e42 <statistics+0x4e>
      break;
    }
    i += n;
    5e3c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    5e3e:	ff24c4e3          	blt	s1,s2,5e26 <statistics+0x32>
  }
  close(fd);
    5e42:	854e                	mv	a0,s3
    5e44:	00000097          	auipc	ra,0x0
    5e48:	ab8080e7          	jalr	-1352(ra) # 58fc <close>
  return i;
}
    5e4c:	8526                	mv	a0,s1
    5e4e:	70a2                	ld	ra,40(sp)
    5e50:	7402                	ld	s0,32(sp)
    5e52:	64e2                	ld	s1,24(sp)
    5e54:	6942                	ld	s2,16(sp)
    5e56:	69a2                	ld	s3,8(sp)
    5e58:	6a02                	ld	s4,0(sp)
    5e5a:	6145                	addi	sp,sp,48
    5e5c:	8082                	ret
      fprintf(2, "stats: open failed\n");
    5e5e:	00002597          	auipc	a1,0x2
    5e62:	40258593          	addi	a1,a1,1026 # 8260 <statistics+0x246c>
    5e66:	4509                	li	a0,2
    5e68:	00000097          	auipc	ra,0x0
    5e6c:	da6080e7          	jalr	-602(ra) # 5c0e <fprintf>
      exit(1);
    5e70:	4505                	li	a0,1
    5e72:	00000097          	auipc	ra,0x0
    5e76:	a62080e7          	jalr	-1438(ra) # 58d4 <exit>
