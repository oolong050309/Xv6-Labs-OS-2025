...
000000000000011a <grep>:
{
 ...
 140:	a64a8a93          	addi	s5,s5,-1436 # ba0 <buf>
 ...
 1ba:	9ea50513          	addi	a0,a0,-1558 # ba0 <buf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5fa:	58a50513          	addi	a0,a0,1418 # b80 <digits>
 5fe:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 700:	42c70713          	addi	a4,a4,1068 # b28 <statistics+0xf2>
 ...
 78c:	3f8b8b93          	addi	s7,s7,1016 # b80 <digits>
 ...
 7e2:	31a90913          	addi	s2,s2,794 # af8 <statistics+0xc2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c2:	2da7b783          	ld	a5,730(a5) # b98 <freep>
 ...
 8ea:	00e6ea63          	bltu	a3,a4,8fe <free+0x4a>
{
 ...
 92c:	26f73823          	sd	a5,624(a4) # b98 <freep>
}
 930:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 956:	24653503          	ld	a0,582(a0) # b98 <freep>
 ...
 986:	21690913          	addi	s2,s2,534 # b98 <freep>
  if(p == (char*)-1)
 98a:	5afd                	li	s5,-1
 ...
 99a:	60a78793          	addi	a5,a5,1546 # fa0 <base>
 99e:	00000717          	auipc	a4,0x0
 9a2:	1ef73d23          	sd	a5,506(a4) # b98 <freep>
 9a6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a18:	18a73223          	sd	a0,388(a4) # b98 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a50:	0b450513          	addi	a0,a0,180 # b00 <statistics+0xca>
 a54:	00000097          	auipc	ra,0x0
 a58:	b02080e7          	jalr	-1278(ra) # 556 <open>
  if(fd < 0) {
 ...
 a76:	abc080e7          	jalr	-1348(ra) # 52e <read>
 ...
 a8a:	ab8080e7          	jalr	-1352(ra) # 53e <close>
  return i;
}
 a8e:	8526                	mv	a0,s1
 ...
 aa4:	07058593          	addi	a1,a1,112 # b10 <statistics+0xda>
 aa8:	4509                	li	a0,2
 aaa:	00000097          	auipc	ra,0x0
 aae:	da6080e7          	jalr	-602(ra) # 850 <fprintf>
      exit(1);
 ab2:	4505                	li	a0,1
 ab4:	00000097          	auipc	ra,0x0
 ab8:	a62080e7          	jalr	-1438(ra) # 516 <exit>
