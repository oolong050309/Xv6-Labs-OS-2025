...
cat(int fd)
{
  ...
  14:	a1890913          	addi	s2,s2,-1512 # a28 <buf>
  ...
  44:	8f858593          	addi	a1,a1,-1800 # 938 <statistics+0x8a>
  48:	4509                	li	a0,2
  ...
  72:	8e258593          	addi	a1,a1,-1822 # 950 <statistics+0xa2>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 10a:	86258593          	addi	a1,a1,-1950 # 968 <statistics+0xba>
 10e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 472:	59a50513          	addi	a0,a0,1434 # a08 <digits>
 476:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 578:	43c70713          	addi	a4,a4,1084 # 9b0 <statistics+0x102>
 ...
 604:	408b8b93          	addi	s7,s7,1032 # a08 <digits>
 ...
 65a:	32a90913          	addi	s2,s2,810 # 980 <statistics+0xd2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 73a:	2ea7b783          	ld	a5,746(a5) # a20 <freep>
 ...
 762:	00e6ea63          	bltu	a3,a4,776 <free+0x4a>
{
 ...
 7a4:	28f73023          	sd	a5,640(a4) # a20 <freep>
}
 7a8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ce:	25653503          	ld	a0,598(a0) # a20 <freep>
 ...
 7fe:	22690913          	addi	s2,s2,550 # a20 <freep>
  if(p == (char*)-1)
 802:	5afd                	li	s5,-1
 ...
 812:	41a78793          	addi	a5,a5,1050 # c28 <base>
 816:	00000717          	auipc	a4,0x0
 81a:	20f73523          	sd	a5,522(a4) # a20 <freep>
 81e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 890:	18a73a23          	sd	a0,404(a4) # a20 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8c8:	0c450513          	addi	a0,a0,196 # 988 <statistics+0xda>
 8cc:	00000097          	auipc	ra,0x0
 8d0:	b02080e7          	jalr	-1278(ra) # 3ce <open>
  if(fd < 0) {
 8d4:	04054263          	bltz	a0,918 <statistics+0x6a>
 8d8:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8da:	4481                	li	s1,0
 8dc:	03205063          	blez	s2,8fc <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8e0:	4099063b          	subw	a2,s2,s1
 8e4:	009a05b3          	add	a1,s4,s1
 8e8:	854e                	mv	a0,s3
 8ea:	00000097          	auipc	ra,0x0
 8ee:	abc080e7          	jalr	-1348(ra) # 3a6 <read>
 8f2:	00054563          	bltz	a0,8fc <statistics+0x4e>
      break;
    }
    i += n;
 8f6:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 8f8:	ff24c4e3          	blt	s1,s2,8e0 <statistics+0x32>
  }
  close(fd);
 8fc:	854e                	mv	a0,s3
 8fe:	00000097          	auipc	ra,0x0
 902:	ab8080e7          	jalr	-1352(ra) # 3b6 <close>
  return i;
}
 906:	8526                	mv	a0,s1
 ...
 91c:	08058593          	addi	a1,a1,128 # 998 <statistics+0xea>
 920:	4509                	li	a0,2
 922:	00000097          	auipc	ra,0x0
 926:	da6080e7          	jalr	-602(ra) # 6c8 <fprintf>
      exit(1);
 92a:	4505                	li	a0,1
 92c:	00000097          	auipc	ra,0x0
 930:	a62080e7          	jalr	-1438(ra) # 38e <exit>
