...
cat(int fd)
{
  ...
  44:	87858593          	addi	a1,a1,-1928 # 8b8 <malloc+0x102>
  48:	4509                	li	a0,2
  ...
  72:	86258593          	addi	a1,a1,-1950 # 8d0 <malloc+0x11a>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 10a:	7e258593          	addi	a1,a1,2018 # 8e8 <malloc+0x132>
 10e:	4509                	li	a0,2
...
malloc(uint nbytes)
{
 ...
 806:	17690913          	addi	s2,s2,374 # 978 <freep>
  if(p == (char*)-1)
 80a:	5afd                	li	s5,-1
 ...
 81a:	36a78793          	addi	a5,a5,874 # b80 <base>
