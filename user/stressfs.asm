...
free(void *ap)
{
 ...
 734:	2307b783          	ld	a5,560(a5) # 960 <freep>
 ...
 75c:	00e6ea63          	bltu	a3,a4,770 <free+0x4a>
{
 ...
 79e:	1cf73323          	sd	a5,454(a4) # 960 <freep>
}
 7a2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c8:	19c53503          	ld	a0,412(a0) # 960 <freep>
 ...
 7f8:	16c90913          	addi	s2,s2,364 # 960 <freep>
  if(p == (char*)-1)
 7fc:	5afd                	li	s5,-1
 ...
 80c:	16078793          	addi	a5,a5,352 # 968 <base>
 810:	00000717          	auipc	a4,0x0
 814:	14f73823          	sd	a5,336(a4) # 960 <freep>
 818:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 88a:	0ca73d23          	sd	a0,218(a4) # 960 <freep>
      return (void*)(p + 1);
