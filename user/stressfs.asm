...
main(int argc, char *argv[])
{
  ...
  1a:	8ba78793          	addi	a5,a5,-1862 # 8d0 <malloc+0x130>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	87450513          	addi	a0,a0,-1932 # 8a0 <malloc+0x100>
  ...
  6c:	85050513          	addi	a0,a0,-1968 # 8b8 <malloc+0x118>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	81250513          	addi	a0,a0,-2030 # 8c8 <malloc+0x128>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 464:	4e050513          	addi	a0,a0,1248 # 940 <digits>
 468:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 56a:	38270713          	addi	a4,a4,898 # 8e8 <malloc+0x148>
 ...
 5f6:	34eb8b93          	addi	s7,s7,846 # 940 <digits>
 ...
 64c:	29890913          	addi	s2,s2,664 # 8e0 <malloc+0x140>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f0:	16c90913          	addi	s2,s2,364 # 958 <freep>
  if(p == (char*)-1)
 7f4:	5afd                	li	s5,-1
 ...
 804:	16078793          	addi	a5,a5,352 # 960 <base>
