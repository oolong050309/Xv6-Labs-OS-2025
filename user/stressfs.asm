...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45c:	59050513          	addi	a0,a0,1424 # 9e8 <digits>
 460:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 562:	43270713          	addi	a4,a4,1074 # 990 <statistics+0xf8>
 ...
 5ee:	3feb8b93          	addi	s7,s7,1022 # 9e8 <digits>
 ...
 644:	32090913          	addi	s2,s2,800 # 960 <statistics+0xc8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 724:	2e07b783          	ld	a5,736(a5) # a00 <freep>
 ...
 74c:	00e6ea63          	bltu	a3,a4,760 <free+0x4a>
{
 ...
 78e:	26f73b23          	sd	a5,630(a4) # a00 <freep>
}
 792:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7b8:	24c53503          	ld	a0,588(a0) # a00 <freep>
 ...
 7e8:	21c90913          	addi	s2,s2,540 # a00 <freep>
  if(p == (char*)-1)
 7ec:	5afd                	li	s5,-1
 ...
 7fc:	21078793          	addi	a5,a5,528 # a08 <base>
 800:	00000717          	auipc	a4,0x0
 804:	20f73023          	sd	a5,512(a4) # a00 <freep>
 808:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 87a:	18a73523          	sd	a0,394(a4) # a00 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8b2:	0ba50513          	addi	a0,a0,186 # 968 <statistics+0xd0>
 ...
 906:	07658593          	addi	a1,a1,118 # 978 <statistics+0xe0>
 90a:	4509                	li	a0,2
 90c:	00000097          	auipc	ra,0x0
 910:	da6080e7          	jalr	-602(ra) # 6b2 <fprintf>
      exit(1);
 914:	4505                	li	a0,1
