...
main(int argc, char *argv[])
{
  ...
  44:	85058593          	addi	a1,a1,-1968 # 890 <statistics+0x8a>
  48:	4509                	li	a0,2
  ...
  62:	85258593          	addi	a1,a1,-1966 # 8b0 <statistics+0xaa>
  66:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	59250513          	addi	a0,a0,1426 # 958 <digits>
 3ce:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	43470713          	addi	a4,a4,1076 # 900 <statistics+0xfa>
 ...
 55c:	400b8b93          	addi	s7,s7,1024 # 958 <digits>
 ...
 5b2:	32290913          	addi	s2,s2,802 # 8d0 <statistics+0xca>
        while(*s != 0){
...
free(void *ap)
{
 ...
 692:	2e27b783          	ld	a5,738(a5) # 970 <freep>
 ...
 6ba:	00e6ea63          	bltu	a3,a4,6ce <free+0x4a>
{
 ...
 6fc:	26f73c23          	sd	a5,632(a4) # 970 <freep>
}
 700:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 726:	24e53503          	ld	a0,590(a0) # 970 <freep>
 ...
 756:	21e90913          	addi	s2,s2,542 # 970 <freep>
  if(p == (char*)-1)
 75a:	5afd                	li	s5,-1
 ...
 76a:	21278793          	addi	a5,a5,530 # 978 <base>
 76e:	00000717          	auipc	a4,0x0
 772:	20f73123          	sd	a5,514(a4) # 970 <freep>
 776:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e8:	18a73623          	sd	a0,396(a4) # 970 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 820:	0bc50513          	addi	a0,a0,188 # 8d8 <statistics+0xd2>
 824:	00000097          	auipc	ra,0x0
 828:	b02080e7          	jalr	-1278(ra) # 326 <open>
  if(fd < 0) {
 82c:	04054263          	bltz	a0,870 <statistics+0x6a>
 830:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 832:	4481                	li	s1,0
 834:	03205063          	blez	s2,854 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 838:	4099063b          	subw	a2,s2,s1
 83c:	009a05b3          	add	a1,s4,s1
 840:	854e                	mv	a0,s3
 842:	00000097          	auipc	ra,0x0
 846:	abc080e7          	jalr	-1348(ra) # 2fe <read>
 84a:	00054563          	bltz	a0,854 <statistics+0x4e>
      break;
    }
    i += n;
 84e:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 850:	ff24c4e3          	blt	s1,s2,838 <statistics+0x32>
  }
  close(fd);
 854:	854e                	mv	a0,s3
 856:	00000097          	auipc	ra,0x0
 85a:	ab8080e7          	jalr	-1352(ra) # 30e <close>
  return i;
}
 85e:	8526                	mv	a0,s1
 ...
 86e:	8082                	ret
      fprintf(2, "stats: open failed\n");
 870:	00000597          	auipc	a1,0x0
 874:	07858593          	addi	a1,a1,120 # 8e8 <statistics+0xe2>
 878:	4509                	li	a0,2
 87a:	00000097          	auipc	ra,0x0
 87e:	da6080e7          	jalr	-602(ra) # 620 <fprintf>
      exit(1);
 882:	4505                	li	a0,1
 884:	00000097          	auipc	ra,0x0
 888:	a62080e7          	jalr	-1438(ra) # 2e6 <exit>
