...
main(int argc, char *argv[])
{
  ...
  14:	86858593          	addi	a1,a1,-1944 # 878 <statistics+0x8a>
  18:	4509                	li	a0,2
  ...
  52:	84258593          	addi	a1,a1,-1982 # 890 <statistics+0xa2>
  56:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b2:	58250513          	addi	a0,a0,1410 # 930 <digits>
 3b6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b8:	42470713          	addi	a4,a4,1060 # 8d8 <statistics+0xea>
 ...
 59a:	31290913          	addi	s2,s2,786 # 8a8 <statistics+0xba>
        while(*s != 0){
...
free(void *ap)
{
 ...
 67a:	2d27b783          	ld	a5,722(a5) # 948 <freep>
 ...
 6a2:	00e6ea63          	bltu	a3,a4,6b6 <free+0x4a>
{
 ...
 6e4:	26f73423          	sd	a5,616(a4) # 948 <freep>
}
 6e8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 70e:	23e53503          	ld	a0,574(a0) # 948 <freep>
 ...
 73e:	20e90913          	addi	s2,s2,526 # 948 <freep>
  if(p == (char*)-1)
 742:	5afd                	li	s5,-1
 ...
 752:	20278793          	addi	a5,a5,514 # 950 <base>
 756:	00000717          	auipc	a4,0x0
 75a:	1ef73923          	sd	a5,498(a4) # 948 <freep>
 75e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d0:	16a73e23          	sd	a0,380(a4) # 948 <freep>
      return (void*)(p + 1);
...
{
 7ee:	7179                	addi	sp,sp,-48
 7f0:	f406                	sd	ra,40(sp)
 7f2:	f022                	sd	s0,32(sp)
 7f4:	ec26                	sd	s1,24(sp)
 7f6:	e84a                	sd	s2,16(sp)
 7f8:	e44e                	sd	s3,8(sp)
 7fa:	e052                	sd	s4,0(sp)
 ...
 808:	0ac50513          	addi	a0,a0,172 # 8b0 <statistics+0xc2>
 80c:	00000097          	auipc	ra,0x0
 810:	b02080e7          	jalr	-1278(ra) # 30e <open>
  if(fd < 0) {
 814:	04054263          	bltz	a0,858 <statistics+0x6a>
 818:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 81a:	4481                	li	s1,0
 81c:	03205063          	blez	s2,83c <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 820:	4099063b          	subw	a2,s2,s1
 824:	009a05b3          	add	a1,s4,s1
 828:	854e                	mv	a0,s3
 82a:	00000097          	auipc	ra,0x0
 82e:	abc080e7          	jalr	-1348(ra) # 2e6 <read>
 832:	00054563          	bltz	a0,83c <statistics+0x4e>
      break;
    }
    i += n;
 836:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 838:	ff24c4e3          	blt	s1,s2,820 <statistics+0x32>
  }
  close(fd);
 83c:	854e                	mv	a0,s3
 83e:	00000097          	auipc	ra,0x0
 842:	ab8080e7          	jalr	-1352(ra) # 2f6 <close>
  return i;
}
 846:	8526                	mv	a0,s1
 ...
 85c:	06858593          	addi	a1,a1,104 # 8c0 <statistics+0xd2>
 860:	4509                	li	a0,2
 862:	00000097          	auipc	ra,0x0
 866:	da6080e7          	jalr	-602(ra) # 608 <fprintf>
      exit(1);
 86a:	4505                	li	a0,1
 86c:	00000097          	auipc	ra,0x0
 870:	a62080e7          	jalr	-1438(ra) # 2ce <exit>
