...
main(int argc, char *argv[])
{
  ...
  14:	80858593          	addi	a1,a1,-2040 # 818 <malloc+0x104>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	614080e7          	jalr	1556(ra) # 62e <fprintf>
    exit(1);
  22:	4505                	li	a0,1
  ...
  38:	310080e7          	jalr	784(ra) # 344 <link>
  3c:	00054763          	bltz	a0,4a <main+0x4a>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0);
  40:	4501                	li	a0,0
  42:	00000097          	auipc	ra,0x0
  46:	2a2080e7          	jalr	674(ra) # 2e4 <exit>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  4a:	6894                	ld	a3,16(s1)
  4c:	6490                	ld	a2,8(s1)
  4e:	00000597          	auipc	a1,0x0
  52:	7e258593          	addi	a1,a1,2018 # 830 <malloc+0x11c>
  56:	4509                	li	a0,2
  58:	00000097          	auipc	ra,0x0
  5c:	5d6080e7          	jalr	1494(ra) # 62e <fprintf>
...
gets(char *buf, int max)
{
 ...
 150:	1b0080e7          	jalr	432(ra) # 2fc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1b2:	18e080e7          	jalr	398(ra) # 33c <fstat>
 1b6:	892a                	mv	s2,a0
  close(fd);
 1b8:	8526                	mv	a0,s1
 1ba:	00000097          	auipc	ra,0x0
 1be:	152080e7          	jalr	338(ra) # 30c <close>
  return r;
 1c2:	64a2                	ld	s1,8(sp)
}
 1c4:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 2d0:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffef44>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d8:	4d450513          	addi	a0,a0,1236 # 8a8 <digits>
 3dc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4de:	37670713          	addi	a4,a4,886 # 850 <malloc+0x13c>
 ...
 56a:	342b8b93          	addi	s7,s7,834 # 8a8 <digits>
 ...
 5c0:	28c90913          	addi	s2,s2,652 # 848 <malloc+0x134>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a0:	2247b783          	ld	a5,548(a5) # 8c0 <freep>
 ...
 6c8:	00e6ea63          	bltu	a3,a4,6dc <free+0x4a>
{
 ...
 70a:	1af73d23          	sd	a5,442(a4) # 8c0 <freep>
}
 70e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 734:	19053503          	ld	a0,400(a0) # 8c0 <freep>
 ...
 764:	16090913          	addi	s2,s2,352 # 8c0 <freep>
  if(p == (char*)-1)
 768:	5afd                	li	s5,-1
 ...
 778:	15478793          	addi	a5,a5,340 # 8c8 <base>
 77c:	00000717          	auipc	a4,0x0
 780:	14f73223          	sd	a5,324(a4) # 8c0 <freep>
 784:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
