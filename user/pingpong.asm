...
main(int argc, char **argv)
{
  ...
  10:	3a0080e7          	jalr	928(ra) # 3ac <pipe>
   pipe(p2);//child -> parent
  14:	fe040513          	addi	a0,s0,-32
  18:	00000097          	auipc	ra,0x0
  1c:	394080e7          	jalr	916(ra) # 3ac <pipe>
   
   pid = fork();
  20:	00000097          	auipc	ra,0x0
  24:	374080e7          	jalr	884(ra) # 394 <fork>
   
   if(pid<0) { exit(1); }
  28:	08054163          	bltz	a0,aa <main+0xaa>
   else if(pid==0)
  2c:	e541                	bnez	a0,b4 <main+0xb4>
   {//child
       close(p1[WRITEEND]);
  2e:	fec42503          	lw	a0,-20(s0)
  32:	00000097          	auipc	ra,0x0
  36:	392080e7          	jalr	914(ra) # 3c4 <close>
       close(p2[READED]);
  3a:	fe042503          	lw	a0,-32(s0)
  3e:	00000097          	auipc	ra,0x0
  42:	386080e7          	jalr	902(ra) # 3c4 <close>
  ...
  5c:	3c4080e7          	jalr	964(ra) # 41c <getpid>
  60:	85aa                	mv	a1,a0
  62:	00001517          	auipc	a0,0x1
  66:	85e50513          	addi	a0,a0,-1954 # 8c0 <malloc+0x104>
  6a:	00000097          	auipc	ra,0x0
  6e:	69a080e7          	jalr	1690(ra) # 704 <printf>
       write(p2[WRITEEND]," ",1);//wrire a byte to p2 
  72:	4605                	li	a2,1
  74:	00001597          	auipc	a1,0x1
  78:	86458593          	addi	a1,a1,-1948 # 8d8 <malloc+0x11c>
  7c:	fe442503          	lw	a0,-28(s0)
  80:	00000097          	auipc	ra,0x0
  84:	33c080e7          	jalr	828(ra) # 3bc <write>
       close(p2[WRITEEND]);
  88:	fe442503          	lw	a0,-28(s0)
  8c:	00000097          	auipc	ra,0x0
  90:	338080e7          	jalr	824(ra) # 3c4 <close>
       close(p1[READED]);
  94:	fe842503          	lw	a0,-24(s0)
  98:	00000097          	auipc	ra,0x0
  9c:	32c080e7          	jalr	812(ra) # 3c4 <close>
       exit(0);
  a0:	4501                	li	a0,0
  a2:	00000097          	auipc	ra,0x0
  a6:	2fa080e7          	jalr	762(ra) # 39c <exit>
   if(pid<0) { exit(1); }
  aa:	4505                	li	a0,1
  ac:	00000097          	auipc	ra,0x0
  b0:	2f0080e7          	jalr	752(ra) # 39c <exit>
   }
   else{
   //parent
      close(p1[READED]);
  ...
  bc:	30c080e7          	jalr	780(ra) # 3c4 <close>
      close(p2[WRITEEND]);
  c0:	fe442503          	lw	a0,-28(s0)
  c4:	00000097          	auipc	ra,0x0
  c8:	300080e7          	jalr	768(ra) # 3c4 <close>
      write(p1[WRITEEND], "x", 1); 
  cc:	4605                	li	a2,1
  ce:	00001597          	auipc	a1,0x1
  d2:	81258593          	addi	a1,a1,-2030 # 8e0 <malloc+0x124>
  d6:	fec42503          	lw	a0,-20(s0)
  da:	00000097          	auipc	ra,0x0
  de:	2e2080e7          	jalr	738(ra) # 3bc <write>
      read(p2[READED],buf,1);
  e2:	4605                	li	a2,1
  e4:	fd840593          	addi	a1,s0,-40
  e8:	fe042503          	lw	a0,-32(s0)
  ec:	00000097          	auipc	ra,0x0
  f0:	2c8080e7          	jalr	712(ra) # 3b4 <read>
      printf("%d: received pong\n", getpid());
  f4:	00000097          	auipc	ra,0x0
  f8:	328080e7          	jalr	808(ra) # 41c <getpid>
  fc:	85aa                	mv	a1,a0
  fe:	00000517          	auipc	a0,0x0
 102:	7ea50513          	addi	a0,a0,2026 # 8e8 <malloc+0x12c>
 106:	00000097          	auipc	ra,0x0
 10a:	5fe080e7          	jalr	1534(ra) # 704 <printf>
      close(p2[READED]);
 10e:	fe042503          	lw	a0,-32(s0)
 112:	00000097          	auipc	ra,0x0
 116:	2b2080e7          	jalr	690(ra) # 3c4 <close>
      close(p1[WRITEEND]);
 11a:	fec42503          	lw	a0,-20(s0)
 11e:	00000097          	auipc	ra,0x0
 122:	2a6080e7          	jalr	678(ra) # 3c4 <close>
   }
   exit(0);
 126:	4501                	li	a0,0
...
free(void *ap)
{
 ...
 748:	2347b783          	ld	a5,564(a5) # 978 <freep>
 ...
 770:	00e6ea63          	bltu	a3,a4,784 <free+0x4a>
{
 ...
 7b2:	1cf73523          	sd	a5,458(a4) # 978 <freep>
}
 7b6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7dc:	1a053503          	ld	a0,416(a0) # 978 <freep>
 ...
 80c:	17090913          	addi	s2,s2,368 # 978 <freep>
  if(p == (char*)-1)
 810:	5afd                	li	s5,-1
 ...
 820:	16478793          	addi	a5,a5,356 # 980 <base>
 824:	00000717          	auipc	a4,0x0
 828:	14f73a23          	sd	a5,340(a4) # 978 <freep>
 82c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 866:	bc2080e7          	jalr	-1086(ra) # 424 <sbrk>
  if(p == (char*)-1)
