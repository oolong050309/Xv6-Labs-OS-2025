...
main(int argc, char *argv[])
{
  ...
  62:	84a58593          	addi	a1,a1,-1974 # 8a8 <statistics+0xa2>
  66:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	58a50513          	addi	a0,a0,1418 # 950 <digits>
 3ce:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	42c70713          	addi	a4,a4,1068 # 8f8 <statistics+0xf2>
 ...
 5b2:	31a90913          	addi	s2,s2,794 # 8c8 <statistics+0xc2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 692:	2da7b783          	ld	a5,730(a5) # 968 <freep>
 ...
 6ba:	00e6ea63          	bltu	a3,a4,6ce <free+0x4a>
{
 ...
 6fc:	26f73823          	sd	a5,624(a4) # 968 <freep>
}
 700:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 726:	24653503          	ld	a0,582(a0) # 968 <freep>
 ...
 756:	21690913          	addi	s2,s2,534 # 968 <freep>
  if(p == (char*)-1)
 75a:	5afd                	li	s5,-1
 ...
 76a:	20a78793          	addi	a5,a5,522 # 970 <base>
 76e:	00000717          	auipc	a4,0x0
 772:	1ef73d23          	sd	a5,506(a4) # 968 <freep>
 776:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e8:	18a73223          	sd	a0,388(a4) # 968 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 820:	0b450513          	addi	a0,a0,180 # 8d0 <statistics+0xca>
 ...
 874:	07058593          	addi	a1,a1,112 # 8e0 <statistics+0xda>
 878:	4509                	li	a0,2
