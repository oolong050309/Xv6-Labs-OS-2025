...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	0bc98993          	addi	s3,s3,188 # 14b8 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	05698993          	addi	s3,s3,86 # 14b8 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	fea98993          	addi	s3,s3,-22 # 14b8 <whitespace>
     4d6:	00001a97          	auipc	s5,0x1
     4da:	fdaa8a93          	addi	s5,s5,-38 # 14b0 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	f7498993          	addi	s3,s3,-140 # 14b8 <whitespace>
...
0000000000000a6c <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa6:	a2648493          	addi	s1,s1,-1498 # 14c8 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     afa:	9d2a0a13          	addi	s4,s4,-1582 # 14c8 <buf.0>
     afe:	8552                	mv	a0,s4
     ...
     b4a:	98250513          	addi	a0,a0,-1662 # 14c8 <buf.0>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1244:	28090913          	addi	s2,s2,640 # 14c0 <freep>
  if(p == (char*)-1)
    1248:	5afd                	li	s5,-1
    ...
    1258:	2dc78793          	addi	a5,a5,732 # 1530 <base>
