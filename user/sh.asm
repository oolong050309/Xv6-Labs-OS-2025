...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	37058593          	addi	a1,a1,880 # 1380 <statistics+0x8c>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	33258593          	addi	a1,a1,818 # 1390 <statistics+0x9c>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	30050513          	addi	a0,a0,768 # 1398 <statistics+0xa4>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3f870713          	addi	a4,a4,1016 # 14bc <statistics+0x1c8>
    ...
    panic("runcmd");
      ...
      e4:	2c050513          	addi	a0,a0,704 # 13a0 <statistics+0xac>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	2a658593          	addi	a1,a1,678 # 13a8 <statistics+0xb4>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	26a58593          	addi	a1,a1,618 # 13b8 <statistics+0xc4>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	1e450513          	addi	a0,a0,484 # 13c8 <statistics+0xd4>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	16c98993          	addi	s3,s3,364 # 1568 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	10698993          	addi	s3,s3,262 # 1568 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	09a98993          	addi	s3,s3,154 # 1568 <whitespace>
     4d6:	00001a97          	auipc	s5,0x1
     4da:	08aa8a93          	addi	s5,s5,138 # 1560 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	02498993          	addi	s3,s3,36 # 1568 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b6:	e3ea8a93          	addi	s5,s5,-450 # 13f0 <statistics+0xfc>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c8:	e0c50513          	addi	a0,a0,-500 # 13d0 <statistics+0xdc>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d5c60613          	addi	a2,a2,-676 # 13f8 <statistics+0x104>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6dc:	d40b0b13          	addi	s6,s6,-704 # 1418 <statistics+0x124>
  ...
  return ret;
     ...
     70a:	cfa50513          	addi	a0,a0,-774 # 1400 <statistics+0x10c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	ca050513          	addi	a0,a0,-864 # 1408 <statistics+0x114>
...
0000000000000792 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b2:	c7260613          	addi	a2,a2,-910 # 1420 <statistics+0x12c>
     7b6:	85ce                	mv	a1,s3
     7b8:	854a                	mv	a0,s2
...
0000000000000800 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     822:	c0aa0a13          	addi	s4,s4,-1014 # 1428 <statistics+0x134>
  ...
  if(peek(ps, es, ";")){
     ...
     858:	bdc60613          	addi	a2,a2,-1060 # 1430 <statistics+0x13c>
     85c:	85ce                	mv	a1,s3
     85e:	854a                	mv	a0,s2
...
00000000000008a8 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8be:	b3e60613          	addi	a2,a2,-1218 # 13f8 <statistics+0x104>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ee:	b5e60613          	addi	a2,a2,-1186 # 1448 <statistics+0x154>
     8f2:	85ca                	mv	a1,s2
     8f4:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     930:	b0c50513          	addi	a0,a0,-1268 # 1438 <statistics+0x144>
     934:	fffff097          	auipc	ra,0xfffff
     938:	720080e7          	jalr	1824(ra) # 54 <panic>
    panic("syntax - missing )");
     93c:	00001517          	auipc	a0,0x1
     940:	b1450513          	addi	a0,a0,-1260 # 1450 <statistics+0x15c>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96c:	b6c70713          	addi	a4,a4,-1172 # 14d4 <statistics+0x1e0>
...
00000000000009e4 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a18:	97460613          	addi	a2,a2,-1676 # 1388 <statistics+0x94>
     a1c:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4e:	a1e58593          	addi	a1,a1,-1506 # 1468 <statistics+0x174>
     a52:	4509                	li	a0,2
     a54:	00000097          	auipc	ra,0x0
     a58:	6ba080e7          	jalr	1722(ra) # 110e <fprintf>
    panic("syntax");
     a5c:	00001517          	auipc	a0,0x1
     a60:	9a450513          	addi	a0,a0,-1628 # 1400 <statistics+0x10c>
...
0000000000000a6c <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	9fc48493          	addi	s1,s1,-1540 # 1478 <statistics+0x184>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa6:	ad648493          	addi	s1,s1,-1322 # 1578 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     afa:	a82a0a13          	addi	s4,s4,-1406 # 1578 <buf.0>
     afe:	8552                	mv	a0,s4
     ...
     b1a:	a6550513          	addi	a0,a0,-1435 # 157b <buf.0+0x3>
     b1e:	00000097          	auipc	ra,0x0
     b22:	326080e7          	jalr	806(ra) # e44 <chdir>
     b26:	fa0551e3          	bgez	a0,ac8 <main+0x5c>
        fprintf(2, "cannot cd %s\n", buf+3);
     b2a:	00001617          	auipc	a2,0x1
     b2e:	a5160613          	addi	a2,a2,-1455 # 157b <buf.0+0x3>
     b32:	00001597          	auipc	a1,0x1
     b36:	94e58593          	addi	a1,a1,-1714 # 1480 <statistics+0x18c>
     b3a:	4509                	li	a0,2
     ...
     b4a:	a3250513          	addi	a0,a0,-1486 # 1578 <buf.0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eb8:	69450513          	addi	a0,a0,1684 # 1548 <digits>
     ebc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fbe:	53670713          	addi	a4,a4,1334 # 14f0 <statistics+0x1fc>
  ...
  putc(fd, 'x');
    ...
    104a:	502b8b93          	addi	s7,s7,1282 # 1548 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10a0:	3f490913          	addi	s2,s2,1012 # 1490 <statistics+0x19c>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1180:	3f47b783          	ld	a5,1012(a5) # 1570 <freep>
    ...
    11a8:	00e6ea63          	bltu	a3,a4,11bc <free+0x4a>
{
  ...
  freep = p;
    ...
    11ea:	38f73523          	sd	a5,906(a4) # 1570 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1214:	36053503          	ld	a0,864(a0) # 1570 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1244:	33090913          	addi	s2,s2,816 # 1570 <freep>
  if(p == (char*)-1)
    1248:	5afd                	li	s5,-1
    ...
    1258:	38c78793          	addi	a5,a5,908 # 15e0 <base>
    125c:	00000717          	auipc	a4,0x0
    1260:	30f73a23          	sd	a5,788(a4) # 1570 <freep>
  ...
  if(p == (char*)-1)
    ...
    12d6:	28a73f23          	sd	a0,670(a4) # 1570 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
    ...
    12fa:	ec26                	sd	s1,24(sp)
    12fc:	e84a                	sd	s2,16(sp)
    12fe:	e44e                	sd	s3,8(sp)
    1300:	e052                	sd	s4,0(sp)
    1302:	1800                	addi	s0,sp,48
    1304:	8a2a                	mv	s4,a0
    1306:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    1308:	4581                	li	a1,0
    130a:	00000517          	auipc	a0,0x0
    130e:	18e50513          	addi	a0,a0,398 # 1498 <statistics+0x1a4>
    1312:	00000097          	auipc	ra,0x0
    1316:	b02080e7          	jalr	-1278(ra) # e14 <open>
  if(fd < 0) {
    131a:	04054263          	bltz	a0,135e <statistics+0x6a>
    131e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    1320:	4481                	li	s1,0
    1322:	03205063          	blez	s2,1342 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    1326:	4099063b          	subw	a2,s2,s1
    132a:	009a05b3          	add	a1,s4,s1
    132e:	854e                	mv	a0,s3
    1330:	00000097          	auipc	ra,0x0
    1334:	abc080e7          	jalr	-1348(ra) # dec <read>
    1338:	00054563          	bltz	a0,1342 <statistics+0x4e>
      break;
    }
    i += n;
    133c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    133e:	ff24c4e3          	blt	s1,s2,1326 <statistics+0x32>
  }
  close(fd);
    1342:	854e                	mv	a0,s3
    1344:	00000097          	auipc	ra,0x0
    1348:	ab8080e7          	jalr	-1352(ra) # dfc <close>
  return i;
}
    134c:	8526                	mv	a0,s1
    134e:	70a2                	ld	ra,40(sp)
    1350:	7402                	ld	s0,32(sp)
    1352:	64e2                	ld	s1,24(sp)
    1354:	6942                	ld	s2,16(sp)
    1356:	69a2                	ld	s3,8(sp)
    1358:	6a02                	ld	s4,0(sp)
    135a:	6145                	addi	sp,sp,48
    135c:	8082                	ret
      fprintf(2, "stats: open failed\n");
    135e:	00000597          	auipc	a1,0x0
    1362:	14a58593          	addi	a1,a1,330 # 14a8 <statistics+0x1b4>
    1366:	4509                	li	a0,2
    1368:	00000097          	auipc	ra,0x0
    136c:	da6080e7          	jalr	-602(ra) # 110e <fprintf>
      exit(1);
    1370:	4505                	li	a0,1
    1372:	00000097          	auipc	ra,0x0
    1376:	a62080e7          	jalr	-1438(ra) # dd4 <exit>
