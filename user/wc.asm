...
wc(int fd, char *name)
{
  ...
  32:	a6ad8d93          	addi	s11,s11,-1430 # a98 <buf>
    for(i=0; i<n; i++){
      c++;
      if(buf[i] == '\n')
  36:	4aa9                	li	s5,10
  ...
  3c:	970a0a13          	addi	s4,s4,-1680 # 9a8 <statistics+0x8c>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  8e:	a0e48493          	addi	s1,s1,-1522 # a98 <buf>
  ...
  aa:	92250513          	addi	a0,a0,-1758 # 9c8 <statistics+0xac>
  ...
  d8:	8e450513          	addi	a0,a0,-1820 # 9b8 <statistics+0x9c>
...
main(int argc, char *argv[])
{
 ...
 15a:	85a58593          	addi	a1,a1,-1958 # 9b0 <statistics+0x94>
 15e:	4501                	li	a0,0
 ...
 17a:	86250513          	addi	a0,a0,-1950 # 9d8 <statistics+0xbc>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e0:	59c50513          	addi	a0,a0,1436 # a78 <digits>
 4e4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5e6:	43e70713          	addi	a4,a4,1086 # a20 <statistics+0x104>
 ...
 6c8:	32c90913          	addi	s2,s2,812 # 9f0 <statistics+0xd4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a8:	2ec7b783          	ld	a5,748(a5) # a90 <freep>
 ...
 7d0:	00e6ea63          	bltu	a3,a4,7e4 <free+0x4a>
{
 ...
 812:	28f73123          	sd	a5,642(a4) # a90 <freep>
}
 816:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 83c:	25853503          	ld	a0,600(a0) # a90 <freep>
 ...
 86c:	22890913          	addi	s2,s2,552 # a90 <freep>
  if(p == (char*)-1)
 870:	5afd                	li	s5,-1
 ...
 880:	41c78793          	addi	a5,a5,1052 # c98 <base>
 884:	00000717          	auipc	a4,0x0
 888:	20f73623          	sd	a5,524(a4) # a90 <freep>
 88c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8fe:	18a73b23          	sd	a0,406(a4) # a90 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 91e:	f406                	sd	ra,40(sp)
 920:	f022                	sd	s0,32(sp)
 922:	ec26                	sd	s1,24(sp)
 924:	e84a                	sd	s2,16(sp)
 926:	e44e                	sd	s3,8(sp)
 928:	e052                	sd	s4,0(sp)
 ...
 936:	0c650513          	addi	a0,a0,198 # 9f8 <statistics+0xdc>
 93a:	00000097          	auipc	ra,0x0
 93e:	b02080e7          	jalr	-1278(ra) # 43c <open>
  if(fd < 0) {
 942:	04054263          	bltz	a0,986 <statistics+0x6a>
 946:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 948:	4481                	li	s1,0
 94a:	03205063          	blez	s2,96a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 94e:	4099063b          	subw	a2,s2,s1
 952:	009a05b3          	add	a1,s4,s1
 956:	854e                	mv	a0,s3
 958:	00000097          	auipc	ra,0x0
 95c:	abc080e7          	jalr	-1348(ra) # 414 <read>
 960:	00054563          	bltz	a0,96a <statistics+0x4e>
      break;
    }
    i += n;
 964:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 966:	ff24c4e3          	blt	s1,s2,94e <statistics+0x32>
  }
  close(fd);
 96a:	854e                	mv	a0,s3
 96c:	00000097          	auipc	ra,0x0
 970:	ab8080e7          	jalr	-1352(ra) # 424 <close>
  return i;
}
 974:	8526                	mv	a0,s1
 976:	70a2                	ld	ra,40(sp)
 978:	7402                	ld	s0,32(sp)
 97a:	64e2                	ld	s1,24(sp)
 97c:	6942                	ld	s2,16(sp)
 97e:	69a2                	ld	s3,8(sp)
 980:	6a02                	ld	s4,0(sp)
 982:	6145                	addi	sp,sp,48
 984:	8082                	ret
      fprintf(2, "stats: open failed\n");
 986:	00000597          	auipc	a1,0x0
 98a:	08258593          	addi	a1,a1,130 # a08 <statistics+0xec>
 98e:	4509                	li	a0,2
 990:	00000097          	auipc	ra,0x0
 994:	da6080e7          	jalr	-602(ra) # 736 <fprintf>
      exit(1);
 998:	4505                	li	a0,1
 99a:	00000097          	auipc	ra,0x0
 99e:	a62080e7          	jalr	-1438(ra) # 3fc <exit>
