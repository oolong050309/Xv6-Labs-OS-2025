...
free(void *ap)
{
 ...
 6b6:	2067b783          	ld	a5,518(a5) # 8b8 <freep>
 ...
 6de:	00e6ea63          	bltu	a3,a4,6f2 <free+0x4a>
{
 ...
 720:	18f73e23          	sd	a5,412(a4) # 8b8 <freep>
}
 724:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 77a:	14290913          	addi	s2,s2,322 # 8b8 <freep>
  if(p == (char*)-1)
 77e:	5afd                	li	s5,-1
 ...
 78e:	13678793          	addi	a5,a5,310 # 8c0 <base>
 792:	00000717          	auipc	a4,0x0
 796:	12f73323          	sd	a5,294(a4) # 8b8 <freep>
 79a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
