...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	55e50513          	addi	a0,a0,1374 # 938 <digits>
 3e2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e4:	40070713          	addi	a4,a4,1024 # 8e0 <statistics+0xc6>
 ...
 570:	3ccb8b93          	addi	s7,s7,972 # 938 <digits>
 ...
 5c6:	2ee90913          	addi	s2,s2,750 # 8b0 <statistics+0x96>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a6:	2ae7b783          	ld	a5,686(a5) # 950 <freep>
 ...
 6ce:	00e6ea63          	bltu	a3,a4,6e2 <free+0x4a>
{
 ...
 710:	24f73223          	sd	a5,580(a4) # 950 <freep>
}
 714:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 73a:	21a53503          	ld	a0,538(a0) # 950 <freep>
 ...
 76a:	1ea90913          	addi	s2,s2,490 # 950 <freep>
  if(p == (char*)-1)
 76e:	5afd                	li	s5,-1
 ...
 77e:	1de78793          	addi	a5,a5,478 # 958 <base>
 782:	00000717          	auipc	a4,0x0
 786:	1cf73723          	sd	a5,462(a4) # 950 <freep>
 78a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7fc:	14a73c23          	sd	a0,344(a4) # 950 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 834:	08850513          	addi	a0,a0,136 # 8b8 <statistics+0x9e>
 838:	00000097          	auipc	ra,0x0
 83c:	b02080e7          	jalr	-1278(ra) # 33a <open>
  if(fd < 0) {
 ...
 85a:	abc080e7          	jalr	-1348(ra) # 312 <read>
 ...
 86e:	ab8080e7          	jalr	-1352(ra) # 322 <close>
  return i;
}
 872:	8526                	mv	a0,s1
 ...
 888:	04458593          	addi	a1,a1,68 # 8c8 <statistics+0xae>
 88c:	4509                	li	a0,2
 88e:	00000097          	auipc	ra,0x0
 892:	da6080e7          	jalr	-602(ra) # 634 <fprintf>
      exit(1);
 896:	4505                	li	a0,1
 898:	00000097          	auipc	ra,0x0
 89c:	a62080e7          	jalr	-1438(ra) # 2fa <exit>
