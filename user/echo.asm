...
main(int argc, char *argv[])
{
  ...
  34:	7f8a8a93          	addi	s5,s5,2040 # 828 <malloc+0x106>
  ...
  76:	7be58593          	addi	a1,a1,1982 # 830 <malloc+0x10e>
  7a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e6:	4b650513          	addi	a0,a0,1206 # 898 <digits>
 3ea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ec:	35870713          	addi	a4,a4,856 # 840 <malloc+0x11e>
 ...
 578:	324b8b93          	addi	s7,s7,804 # 898 <digits>
 ...
 5ce:	26e90913          	addi	s2,s2,622 # 838 <malloc+0x116>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 772:	14290913          	addi	s2,s2,322 # 8b0 <freep>
  if(p == (char*)-1)
 776:	5afd                	li	s5,-1
 ...
 786:	13678793          	addi	a5,a5,310 # 8b8 <base>
