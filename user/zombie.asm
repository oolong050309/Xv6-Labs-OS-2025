...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37a:	55250513          	addi	a0,a0,1362 # 8c8 <digits>
 37e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 480:	3f470713          	addi	a4,a4,1012 # 870 <statistics+0xba>
 ...
 50c:	3c0b8b93          	addi	s7,s7,960 # 8c8 <digits>
 ...
 562:	2e290913          	addi	s2,s2,738 # 840 <statistics+0x8a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 642:	2a27b783          	ld	a5,674(a5) # 8e0 <freep>
 ...
 66a:	00e6ea63          	bltu	a3,a4,67e <free+0x4a>
{
 ...
 6ac:	22f73c23          	sd	a5,568(a4) # 8e0 <freep>
}
 6b0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6d6:	20e53503          	ld	a0,526(a0) # 8e0 <freep>
 ...
 706:	1de90913          	addi	s2,s2,478 # 8e0 <freep>
  if(p == (char*)-1)
 70a:	5afd                	li	s5,-1
 ...
 71a:	1d278793          	addi	a5,a5,466 # 8e8 <base>
 ...
 798:	14a73623          	sd	a0,332(a4) # 8e0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 7d0:	07c50513          	addi	a0,a0,124 # 848 <statistics+0x92>
 ...
 824:	03858593          	addi	a1,a1,56 # 858 <statistics+0xa2>
 828:	4509                	li	a0,2
 82a:	00000097          	auipc	ra,0x0
 82e:	da6080e7          	jalr	-602(ra) # 5d0 <fprintf>
      exit(1);
 832:	4505                	li	a0,1
