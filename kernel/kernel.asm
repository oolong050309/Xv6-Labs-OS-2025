...
allocpid() {
  ...
  pid = nextpid;
    ...
    80000f1c:	8fc78793          	addi	a5,a5,-1796 # 80008814 <nextpid>
...
0000000080001154 <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    80001178:	6ac58593          	addi	a1,a1,1708 # 80008820 <initcode>
...
sys_sleep(void)
{
  ...
  return 0;
    ...
    8000219c:	ce850513          	addi	a0,a0,-792 # 8000ee80 <tickslock>
...
sys_uptime(void)
{
  ...
  release(&tickslock);
    ...
    8000220a:	c7a50513          	addi	a0,a0,-902 # 8000ee80 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002242:	c5a50513          	addi	a0,a0,-934 # 8000ee98 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002252:	c4a78793          	addi	a5,a5,-950 # 80016e98 <bcache+0x8000>
    80002256:	00015717          	auipc	a4,0x15
    8000225a:	eaa70713          	addi	a4,a4,-342 # 80017100 <bcache+0x8268>
    8000225e:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002262:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002266:	0000d497          	auipc	s1,0xd
    8000226a:	c4a48493          	addi	s1,s1,-950 # 8000eeb0 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    800022ca:	bd250513          	addi	a0,a0,-1070 # 8000ee98 <bcache>
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    800022e2:	e2278793          	addi	a5,a5,-478 # 80017100 <bcache+0x8268>
    ...
    8000230a:	b9250513          	addi	a0,a0,-1134 # 8000ee98 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002330:	dd478793          	addi	a5,a5,-556 # 80017100 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002368:	b3450513          	addi	a0,a0,-1228 # 8000ee98 <bcache>
...
brelse(struct buf *b)
{
  ...
  if (b->refcnt == 0) {
    ...
    80002436:	a6678793          	addi	a5,a5,-1434 # 80016e98 <bcache+0x8000>
    8000243a:	2b87b703          	ld	a4,696(a5)
    8000243e:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002440:	00015717          	auipc	a4,0x15
    80002444:	cc070713          	addi	a4,a4,-832 # 80017100 <bcache+0x8268>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024cc:	9d050513          	addi	a0,a0,-1584 # 8000ee98 <bcache>
  ...
  release(&bcache.lock);
    ...
    800024e2:	9ba50513          	addi	a0,a0,-1606 # 8000ee98 <bcache>
...
0000000080002574 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    800025a0:	fbcb0b13          	addi	s6,s6,-68 # 80017558 <sb>
...
000000008000277e <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002796:	de650513          	addi	a0,a0,-538 # 80017578 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    800027a8:	dec48493          	addi	s1,s1,-532 # 80017590 <itable+0x18>
    800027ac:	00017697          	auipc	a3,0x17
    800027b0:	87468693          	addi	a3,a3,-1932 # 80019020 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    800027dc:	da050513          	addi	a0,a0,-608 # 80017578 <itable>
  ...
  release(&itable.lock);
    ...
    8000280c:	d7050513          	addi	a0,a0,-656 # 80017578 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    8000285a:	d0298993          	addi	s3,s3,-766 # 80017558 <sb>
  ...
  initlog(dev, &sb);
    ...
    8000288e:	cce58593          	addi	a1,a1,-818 # 80017558 <sb>
...
00000000800028ba <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800028d4:	ca850513          	addi	a0,a0,-856 # 80017578 <itable>
    800028d8:	00004097          	auipc	ra,0x4
    800028dc:	82e080e7          	jalr	-2002(ra) # 80006106 <initlock>
  for(i = 0; i < NINODE; i++) {
    800028e0:	00015497          	auipc	s1,0x15
    800028e4:	cc048493          	addi	s1,s1,-832 # 800175a0 <itable+0x28>
    800028e8:	00016997          	auipc	s3,0x16
    800028ec:	74898993          	addi	s3,s3,1864 # 80019030 <log+0x10>
...
000000008000291a <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80002946:	c16a0a13          	addi	s4,s4,-1002 # 80017558 <sb>
...
0000000080002a70 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002a80:	afc50513          	addi	a0,a0,-1284 # 80017578 <itable>
  ...
  release(&itable.lock);
    ...
    80002a96:	ae650513          	addi	a0,a0,-1306 # 80017578 <itable>
...
0000000080002c6c <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002c7c:	90050513          	addi	a0,a0,-1792 # 80017578 <itable>
  ...
  release(&itable.lock);
    ...
    80002c9a:	8e250513          	addi	a0,a0,-1822 # 80017578 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002cce:	8ae50513          	addi	a0,a0,-1874 # 80017578 <itable>
    ...
    80002d04:	87850513          	addi	a0,a0,-1928 # 80017578 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    800032ca:	d5a90913          	addi	s2,s2,-678 # 80019020 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800032ee:	d6670713          	addi	a4,a4,-666 # 80019050 <log+0x30>
    ...
    8000332c:	0af05d63          	blez	a5,800033e6 <install_trans+0xc2>
{
    ...
    8000334a:	d0aa8a93          	addi	s5,s5,-758 # 80019050 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    8000334e:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003350:	00016997          	auipc	s3,0x16
    80003354:	cd098993          	addi	s3,s3,-816 # 80019020 <log>
...
00000000800033e8 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    800033fe:	c2648493          	addi	s1,s1,-986 # 80019020 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000343c:	c1870713          	addi	a4,a4,-1000 # 80019050 <log+0x30>
...
begin_op(void)
{
  ...
  while(1){
    ...
    800034e0:	b4450513          	addi	a0,a0,-1212 # 80019020 <log>
...
end_op(void)
{
  ...
  if(log.outstanding == 0){
    ...
    8000352e:	af648493          	addi	s1,s1,-1290 # 80019020 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    8000354a:	ada48493          	addi	s1,s1,-1318 # 80019020 <log>
    ...
    8000358c:	a9848493          	addi	s1,s1,-1384 # 80019020 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800035ba:	a9aa8a93          	addi	s5,s5,-1382 # 80019050 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800035be:	00016a17          	auipc	s4,0x16
    800035c2:	a62a0a13          	addi	s4,s4,-1438 # 80019020 <log>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    8000366a:	9ba90913          	addi	s2,s2,-1606 # 80019020 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800036a8:	9ac70713          	addi	a4,a4,-1620 # 80019050 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    800036c4:	96078793          	addi	a5,a5,-1696 # 80019020 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    800036dc:	94870713          	addi	a4,a4,-1720 # 80019020 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003712:	91270713          	addi	a4,a4,-1774 # 80019020 <log>
  ...
  release(&log.lock);
    ...
    80003724:	90050513          	addi	a0,a0,-1792 # 80019020 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    8000387a:	8f250513          	addi	a0,a0,-1806 # 80019168 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    8000389c:	8d050513          	addi	a0,a0,-1840 # 80019168 <ftable>
    800038a0:	00003097          	auipc	ra,0x3
    800038a4:	8f6080e7          	jalr	-1802(ra) # 80006196 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800038a8:	00016497          	auipc	s1,0x16
    800038ac:	8d848493          	addi	s1,s1,-1832 # 80019180 <ftable+0x18>
    800038b0:	00017717          	auipc	a4,0x17
    800038b4:	87070713          	addi	a4,a4,-1936 # 8001a120 <ftable+0xfb8>
    if(f->ref == 0){
  ...
  return 0;
    ...
    800038e0:	88c50513          	addi	a0,a0,-1908 # 80019168 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003908:	86450513          	addi	a0,a0,-1948 # 80019168 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003922:	84a50513          	addi	a0,a0,-1974 # 80019168 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003b36:	59670713          	addi	a4,a4,1430 # 800190c8 <devsw>
    ...
    80003b74:	12078963          	beqz	a5,80003ca6 <filewrite+0x136>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003be0:	4ec70713          	addi	a4,a4,1260 # 800190c8 <devsw>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  ustack[argc] = 0;
    ...
    800042a2:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffd8d50>
...
0000000080005c66 <printf>:
{
  ...
  consputc('x');
    ...
    80005cda:	51250513          	addi	a0,a0,1298 # 800261e8 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80005ee8:	32450513          	addi	a0,a0,804 # 80026208 <uart_tx_lock>
    ...
    80005f5a:	06f70f63          	beq	a4,a5,80005fd8 <uartstart+0x8e>
{
    ...
    80005f7c:	290a8a93          	addi	s5,s5,656 # 80026208 <uart_tx_lock>
    uart_tx_r += 1;
    80005f80:	00003497          	auipc	s1,0x3
    80005f84:	0a048493          	addi	s1,s1,160 # 80009020 <uart_tx_r>
    ...
    80005f90:	09c98993          	addi	s3,s3,156 # 80009028 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
0000000080005fda <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    80005fea:	22250513          	addi	a0,a0,546 # 80026208 <uart_tx_lock>
  ...
  if(panicked){
    ...
    80006024:	1e898993          	addi	s3,s3,488 # 80026208 <uart_tx_lock>
    80006028:	00003497          	auipc	s1,0x3
    8000602c:	ff848493          	addi	s1,s1,-8 # 80009020 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006030:	00003917          	auipc	s2,0x3
    80006034:	ff890913          	addi	s2,s2,-8 # 80009028 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    800060dc:	13048493          	addi	s1,s1,304 # 80026208 <uart_tx_lock>
